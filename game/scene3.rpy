label scene_3:
    ...
    #voice "voice/3-scene_3-2.ogg" #Raine (VA Name)
    mc "Yeah, I'm kind of a heavy sleeper. How long was I out for?"
    #voice "voice/3-scene_3-3.ogg" #Leona (VA Name)
    le "About sixty ticks or so."
    #voice "voice/3-scene_3-4.ogg" #Raine (VA Name)
    mc "Sixty... hours?"
    #voice "voice/3-scene_3-5.ogg" #Leona (VA Name)
    ...
    #voice "voice/3-scene_3-6.ogg" #Raine (VA Name)
    mc "I see."
    #voice "voice/3-scene_3-7.ogg" #Leona (VA Name)
    ...
    #voice "voice/3-scene_3-9.ogg" #Leona (VA Name)
    ...
    #voice "voice/3-scene_3-10.ogg" #Raine (VA Name)
    mc "What's this?"
    #voice "voice/3-scene_3-11.ogg" #Leona (VA Name)
    ...
    #voice "voice/3-scene_3-12.ogg" #Raine (VA Name)
    mc "Thanks for the meal, Leona."
    #voice "voice/3-scene_3-13.ogg" #Raine (VA Name)
    mc "..."
    #voice "voice/3-scene_3-14.ogg" #Raine (VA Name)
    mc "Blech!"
    #voice "voice/3-scene_3-15.ogg" #Raine (VA Name)
    mc "This inop root... it's so spicy!"
    na "I can't even chew it without an intense wave of heat burning my tongue. "
    #voice "voice/3-scene_3-16.ogg" #Leona (VA Name)
    le "Spicy? What do you mean?"
    #voice "voice/3-scene_3-17.ogg" #Raine (VA Name)
    mc "Mouth... on f-fire..."
    #voice "voice/3-scene_3-18.ogg" #Leona (VA Name)
    le "Oh no!"
    na "She grabs a glass of water and splashes my mouth — and the rest of my face — with it."
    #voice "voice/3-scene_3-19.ogg" #Raine (VA Name)
    mc "Ack! How can you eat that?!?"
    #voice "voice/3-scene_3-20.ogg" #Raine (VA Name)
    mc "My eyes are watering and my tongue feels like it's swelling up."
    #voice "voice/3-scene_3-21.ogg" #Leona (VA Name)
    le "I don't know! I don't know what you mean by 'spicy'! Inop root is just a..."
    na "Her eyes widen."
    #voice "voice/3-scene_3-22.ogg" #Leona (VA Name)
    le "Oh shoot! None of the animals here on this planet will eat this stuff! That must be it!"
    #voice "voice/3-scene_3-23.ogg" #Leona (VA Name)
    ...
    #voice "voice/3-scene_3-57.ogg" #Raine (VA Name)
    ...
    #voice "voice/3-scene_3-80.ogg" #Raine (VA Name)
    mc "I've... changed my mind. Let's go."
    #voice "voice/3-scene_3-81.ogg" #Leona (VA Name)
    le "All right!"
    ...
    #voice "voice/3-scene_3-82.ogg" #Leona (VA Name)
    ...
    #voice "voice/3-scene_3-83.ogg" #Raine (VA Name)
    mc "Just how far away is this base of yours?"
    #voice "voice/3-scene_3-84.ogg" #Leona (VA Name)
    le "Oh, right across the street from my house!"
    #voice "voice/3-scene_3-85.ogg" #Raine (VA Name)
    mc "Wait, aren't we walking away from it, then?"
    #voice "voice/3-scene_3-86.ogg" #Leona (VA Name)
    le "Yep!"
    #voice "voice/3-scene_3-87.ogg" #Raine (VA Name)
    mc "..."
    #voice "voice/3-scene_3-88.ogg" #Leona (VA Name)
    le "...?"
    #voice "voice/3-scene_3-89.ogg" #Raine (VA Name)
