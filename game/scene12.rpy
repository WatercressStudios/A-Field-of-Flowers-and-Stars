label scene_12:
    ...
    voice "voice/12-scene_12-1.ogg" #Raine (Nat)
    mc "I think... we're ready."

    #show leona

    voice "voice/12-scene_12-2.ogg" #Leona (Dot)
    le "Ready for what?"

    voice "voice/12-scene_12-3.ogg" #Raine (Nat)
    mc "Ah, hey there."

    voice "voice/12-scene_12-4.ogg" #Leona (Dot)
    le "Hey."

    voice "voice/12-scene_12-5.ogg" #Raine (Nat)
    mc "I was thinking... remember last night?"

    voice "voice/12-scene_12-6.ogg" #Leona (Dot)
    le "About the test flight?"

    voice "voice/12-scene_12-7.ogg" #Raine (Nat)
    mc "Yeah. I think we have things ready to go for one today. Interested?"

    voice "voice/12-scene_12-8.ogg" #Leona (Dot)
    le "Do you even have to ask? Of course I am!"

    voice "voice/12-scene_12-9.ogg" #Raine (Nat)
    mc "Well, step aboard."
    ...
    voice "voice/12-scene_12-10.ogg" #Juneau (Lily)
    ju "Welcome aboard, Raine. Are we flying today?"

    voice "voice/12-scene_12-11.ogg" #Juneau (Lily)
    ...
    voice "voice/12-scene_12-18.ogg" #Juneau (Lily)
    ju "Good job."

    voice "voice/12-scene_12-19.ogg" #Raine (Nat)
    ...
    voice "voice/12-scene_12-20.ogg" #Leona (Dot)
    le "Oh, I helped!"
    na "Leona here found the parts we needed to get back in business."

    voice "voice/12-scene_12-21.ogg" #Juneau (Lily)
    ju "So I've heard. Good morning, Leona."

    voice "voice/12-scene_12-22.ogg" #Leona (Dot)
    le "Heya!"

    voice "voice/12-scene_12-23.ogg" #Leona (Dot)
    le "So, anything else we need to do?"

    voice "voice/12-scene_12-24.ogg" #Juneau (Lily)
    ju "Nope, you can just take a seat and strap in."

    voice "voice/12-scene_12-25.ogg" #Leona (Dot)
    le "Awesome!"
    na "Leona eagerly sits down at the nearest chair and bounces happily, waiting for me to sit down as well."

    voice "voice/12-scene_12-26.ogg" #Raine (Nat)
    ...
    voice "voice/12-scene_12-27.ogg" #Leona (Dot)
    le "So how do we get to—"

    play sound3 "sfx/engines2.ogg" fadein 1.0
    #faster engine SFX

    voice "voice/12-scene_12-28.ogg" #Leona (Dot)
    le "—spaaaaaaaace!?"
    ...
    voice "voice/12-scene_12-29.ogg" #Juneau (Lily)
    ju "Okay, we're stable. You guys want to try zero gravity?"

    play music "music/floating.ogg" fadein 2.0

    voice "voice/12-scene_12-30.ogg" #Leona (Dot)
    le "Huh?"

    voice "voice/12-scene_12-31.ogg" #Raine (Nat)
    ...
    voice "voice/12-scene_12-32.ogg" #Leona (Dot)
    le "Ah! I'm floating!"

    voice "voice/12-scene_12-33.ogg" #Raine (Nat)
    mc "That's what zero gravity does, silly."
    na "I guide her around the cabin, showing her how to move around."

    voice "voice/12-scene_12-34.ogg" #Leona (Dot)
    le "Wheeee!"

    voice "voice/12-scene_12-35.ogg" #Raine (Nat)
    ...
    voice "voice/12-scene_12-36.ogg" #Leona (Dot)
    le "Raine, that was amazing!"

    voice "voice/12-scene_12-37.ogg" #Raine (Nat)
    mc "Was that your first time flying?"

    voice "voice/12-scene_12-38.ogg" #Leona (Dot)
    le "Not like that. My hoverbike is the most I've ever been off the ground."

    voice "voice/12-scene_12-39.ogg" #Raine (Nat)
    mc "You're missing out."

    voice "voice/12-scene_12-40.ogg" #Leona (Dot)
    ...
    voice "voice/12-scene_12-41.ogg" #Raine (Nat)
    mc "Why?"

    voice "voice/12-scene_12-42.ogg" #Leona (Dot)
    le "We don't have a need for it at the moment. We've spent most of our time and resources focused on building out Aster."

    voice "voice/12-scene_12-43.ogg" #Raine (Nat)
    mc "Ah, makes sense."
    ...
    voice "voice/12-scene_12-44.ogg" #Leona (Dot)
    le "Raine?"

    voice "voice/12-scene_12-45.ogg" #Raine (Nat)
    mc "Hm?"

    voice "voice/12-scene_12-46.ogg" #Leona (Dot)
    le "You looked like you were spacing out again. You okay?"

    voice "voice/12-scene_12-47.ogg" #Raine (Nat)
    mc "Yeah, sorry. Just a bit tired."

    voice "voice/12-scene_12-48.ogg" #Leona (Dot)
    le "Well, it's getting late anyway. Let's head home! I'll cook for you."

    voice "voice/12-scene_12-49.ogg" #Raine (Nat)
    mc "I'd like that."
    ...
    voice "voice/12-scene_12-50.ogg" #Raine (Nat)
    mc "Okay, we're here!"

    voice "voice/12-scene_12-51.ogg" #Leona (Dot)
    ...
    voice "voice/12-scene_12-52.ogg" #Juneau (Lily)
    ju "You know, you need to make a decision soon."

    voice "voice/12-scene_12-53.ogg" #Raine (Nat)
    mc "Yea, yeah."

    voice "voice/12-scene_12-54.ogg" #Raine (Nat)
    ...
    voice "voice/12-scene_12-55.ogg" #Juneau (Lily)
    ju "It's still there, but not for long. We have a little over a day."

    voice "voice/12-scene_12-56.ogg" #Raine (Nat)
    mc "Until the wormhole's gone forever."

    voice "voice/12-scene_12-57.ogg" #Juneau (Lily)
    ...
    voice "voice/12-scene_12-58.ogg" #Leona (Dot)
    le "Raine? You there?"
    na "That's why she wants to come with."
    na "I'm such an idiot."

    voice "voice/12-scene_12-59.ogg" #Raine (Nat)
    mc "Ah, sorry. I'm more tired than I thought."

    voice "voice/12-scene_12-60.ogg" #Leona (Dot)
    le "Maybe some food will help! Come on, eat with me."

    voice "voice/12-scene_12-61.ogg" #Raine (Nat)
    ...
    voice "voice/12-scene_12-62.ogg" #Leona (Dot)
    le "Hey, Raine..."

    voice "voice/12-scene_12-63.ogg" #Raine (Nat)
    mc "Yeah?"

    voice "voice/12-scene_12-64.ogg" #Leona (Dot)
    le "Tell me about Lumin."

    voice "voice/12-scene_12-65.ogg" #Raine (Nat)
    mc "Why?"

    voice "voice/12-scene_12-66.ogg" #Leona (Dot)
    le "I just want to know what your home is like."

    voice "voice/12-scene_12-67.ogg" #Raine (Nat)
    mc "Well, it's mostly urban. The whole planet is one big city, save for a few aforementioned places."

    voice "voice/12-scene_12-68.ogg" #Raine (Nat)
    mc "The entire city is this one big hub of information, electricity, and people."

    voice "voice/12-scene_12-69.ogg" #Raine (Nat)
    mc "For a while, it was home."

    voice "voice/12-scene_12-70.ogg" #Raine (Nat)
    mc "I managed to make a living as an engineer and for a while, it was fun."

    voice "voice/12-scene_12-71.ogg" #Leona (Dot)
    le "For a while?"

    voice "voice/12-scene_12-72.ogg" #Raine (Nat)
    mc "Yeah."

    voice "voice/12-scene_12-73.ogg" #Raine (Nat)
    mc "Something in me just got... sad, I guess. I wanted to see what was out there."

    voice "voice/12-scene_12-74.ogg" #Raine (Nat)
    mc "I kept thinking to myself, 'Is this it for me? Could I be doing more with my life?'"

    voice "voice/12-scene_12-75.ogg" #Raine (Nat)
    mc "So I decided I'd get out there and explore. I built a ship and took off."

    voice "voice/12-scene_12-76.ogg" #Leona (Dot)
    le "And that's how you ended up here?"

    voice "voice/12-scene_12-77.ogg" #Raine (Nat)
    mc "Eventually, yeah."

    voice "voice/12-scene_12-78.ogg" #Leona (Dot)
    le "I think I understand. You really wanted to explore, like me."

    voice "voice/12-scene_12-79.ogg" #Raine (Nat)
    mc "Yeah."

    voice "voice/12-scene_12-80.ogg" #Leona (Dot)
    le "That's so cool! I don't know if I would have been able to do all of that on my own."

    voice "voice/12-scene_12-81.ogg" #Leona (Dot)
    le "You're really brave."

    voice "voice/12-scene_12-82.ogg" #Raine (Nat)
    mc "Heh, thanks."

    voice "voice/12-scene_12-83.ogg" #Raine (Nat)
    mc "It was pretty scary, actually."

    voice "voice/12-scene_12-84.ogg" #Raine (Nat)
    mc "I just... up and left without much fanfare. Heck, my apartment is still there with a few of my things."

    voice "voice/12-scene_12-85.ogg" #Raine (Nat)
    mc "It was kind of impulsive."

    voice "voice/12-scene_12-86.ogg" #Leona (Dot)
    le "I'll say!"

    voice "voice/12-scene_12-87.ogg" #Raine (Nat)
    mc "But, you know..."
    na "I reach out and hold her hand."

    voice "voice/12-scene_12-88.ogg" #Raine (Nat)
    mc "I'd do it all over again if it meant I could meet you every time."

    voice "voice/12-scene_12-89.ogg" #Leona (Dot)
    le "Raine, I... wow."
    na "Her cheeks are so red they're practically glowing."

    voice "voice/12-scene_12-90.ogg" #Leona (Dot)
    le "That's um..."

    voice "voice/12-scene_12-91.ogg" #Leona (Dot)
    le "Um..."

    voice "voice/12-scene_12-92.ogg" #Leona (Dot)
    le "..."
    ...
    voice "voice/12-scene_12-93.ogg" #Leona (Dot)
    le "Raine... I like you. I {i}really{/i} like you. Like, {i}like{/i} like you."

    voice "voice/12-scene_12-94.ogg" #Leona (Dot)
    le "I just... don't want you to go, Raine!"

    voice "voice/12-scene_12-95.ogg" #Leona (Dot)
    ...
    voice "voice/12-scene_12-96.ogg" #Raine (Nat)
    mc "Leona."
    #show kiss_CG3
    na "I love you too."
    ...
    voice "voice/12-scene_12-111.ogg" #Raine (Nat)
    mc "Open up, Juneau!"

    voice "voice/12-scene_12-112.ogg" #Raine (Nat)
    mc "We're heading out."
    na "The ship's bay doors open, and I hop inside."

    voice "voice/12-scene_12-113.ogg" #Juneau (Lily)
    ju "It's so late, though... can't it wait until morning?"
    #show inside_ship

    voice "voice/12-scene_12-114.ogg" #Raine (Nat)
    mc "No, we should leave early before the wormhole closes."

    voice "voice/12-scene_12-115.ogg" #Juneau (Lily)
    ju "And your girlfriend? Is she coming, too?"

    voice "voice/12-scene_12-116.ogg" #Raine (Nat)
    mc "I..."

    voice "voice/12-scene_12-117.ogg" #Juneau (Lily)
    ju "I saw the way you looked at her earlier. You're in love with her, right?"

    voice "voice/12-scene_12-118.ogg" #Raine (Nat)
    mc "What makes you say that?"

    voice "voice/12-scene_12-119.ogg" #Juneau (Lily)
    ju "The Raine I know doesn't smile like that at just anyone."

    voice "voice/12-scene_12-120.ogg" #Juneau (Lily)
    ju "Not even me."

    voice "voice/12-scene_12-121.ogg" #Juneau (Lily)
    ju "And frankly, I'm insulted."

    voice "voice/12-scene_12-122.ogg" #Raine (Nat)
    mc "About... what, exactly?"

    voice "voice/12-scene_12-123.ogg" #Juneau (Lily)
    ...
    voice "voice/12-scene_12-124.ogg" #Juneau (Lily)
    ...
    voice "voice/12-scene_12-125.ogg" #Juneau (Lily)
    ...
    voice "voice/12-scene_12-126.ogg" #Raine (Nat)
    mc "I'm not... stupid."

    voice "voice/12-scene_12-127.ogg" #Juneau (Lily)
    ju "Bullshit."
    #pause (5)

    voice "voice/12-scene_12-128.ogg" #Raine (Nat)
    mc "...Shit."
    ...
    voice "voice/12-scene_12-129.ogg" #Raine (Nat)
    mc "Juneau... thank you."

    voice "voice/12-scene_12-130.ogg" #Juneau (Lily)
    ...
    voice "voice/12-scene_12-146.ogg" #Raine (Nat)
    mc "I love you, Leona."

    voice "voice/12-scene_12-147.ogg" #Leona (Dot)
    le "I love you too."
    ...
    voice "voice/12-scene_12-148.ogg" #Juneau (Lily)
    ju "You sure have a lot of stuff, Leona."

    voice "voice/12-scene_12-149.ogg" #Leona (Dot)
    ...
    voice "voice/12-scene_12-157.ogg" #Raine (Nat)
    mc "Well, I think that's everything."

    voice "voice/12-scene_12-158.ogg" #Leona (Dot)
    le "Got anything else you want to grab before we say goodbye?"

    voice "voice/12-scene_12-159.ogg" #Raine (Nat)
    mc "You packed extra o'eke'ke, right?"

    voice "voice/12-scene_12-160.ogg" #Leona (Dot)
    le "Yup!"

    voice "voice/12-scene_12-161.ogg" #Raine (Nat)
    mc "Then we're fine."

    voice "voice/12-scene_12-162.ogg" #Leona (Dot)
    le "Yay!"

    voice "voice/12-scene_12-163.ogg" #Raine (Nat)
    mc "Are {b}you{/b} ready, Leona? It's going to be a long time before we see Fireside again."

    voice "voice/12-scene_12-164.ogg" #Leona (Dot)
    le "I wouldn't have packed all of my life into your ship if I wasn't ready, Raine."
    na "She sits down and straps herself in."

    voice "voice/12-scene_12-165.ogg" #Leona (Dot)
    le "Let's go!"

    voice "voice/12-scene_12-166.ogg" #Raine (Nat)
    mc "All right then!"

    voice "voice/12-scene_12-167.ogg" #Raine (Nat)
    mc "Juneau, you know what to do."

    voice "voice/12-scene_12-168.ogg" #Juneau (Lily)
    ...
    voice "voice/12-scene_12-193.ogg" #Raine (Nat)
    ...
    voice "voice/12-scene_12-194.ogg" #Juneau (Lily)
    ju "Gravity is getting stronger here. Watch out!"

    voice "voice/12-scene_12-195.ogg" #Raine (Nat)
    mc "Got it!"
    #switch SFX
    ...
    voice "voice/12-scene_12-196.ogg" #Juneau (Lily)
    ju "Getting ready to decelerate. Don't want to collide with {b}another{/b} asteroid as soon as we leave."

    voice "voice/12-scene_12-197.ogg" #Raine (Nat)
    mc "Good call."

    voice "voice/12-scene_12-198.ogg" #Raine (Nat)
    mc "Almost there. And...."
    na "The ship finally exits the wormhole."

    voice "voice/12-scene_12-199.ogg" #Raine (Nat)
    mc "We're out!"

    voice "voice/12-scene_12-200.ogg" #Juneau (Lily)
    ju "Decelerating."
    na "The ship slows down until we get to a more reasonable speed."

    voice "voice/12-scene_12-201.ogg" #Juneau (Lily)
    ...
    voice "voice/12-scene_12-202.ogg" #Raine (Nat)
    mc "Well Leona, we're here!"

    voice "voice/12-scene_12-203.ogg" #Leona (Dot)
    le "That was awesome! Where should we go first?"

    voice "voice/12-scene_12-204.ogg" #Raine (Nat)
    mc "I think we should try this place out."

    voice "voice/12-scene_12-205.ogg" #Raine (Nat)
    mc "I scroll my map to one place I've been thinking about for a while."

    voice "voice/12-scene_12-206.ogg" #Leona (Dot)
    le "What's that planet?"

    voice "voice/12-scene_12-207.ogg" #Raine (Nat)
    mc "Lumin."

    voice "voice/12-scene_12-208.ogg" #Raine (Nat)
    mc "Home."

    voice "voice/12-scene_12-209.ogg" #Raine (Nat)
    mc "You've shown me your home, so how about I show you mine?"

    voice "voice/12-scene_12-210.ogg" #Leona (Dot)
    le "I'd love that."

    voice "voice/12-scene_12-211.ogg" #Raine (Nat)
    mc "Juneau, take us home."

    voice "voice/12-scene_12-212.ogg" #Juneau (Lily)
    ju "Sounds good to me."

    voice "voice/12-scene_12-213.ogg" #Raine (Nat)
    mc "I'm going to be honest, I wasn't entirely sure we'd make the trip back."

    voice "voice/12-scene_12-214.ogg" #Leona (Dot)
    le "I never doubted you. I'm glad you got us here safe and sound."

    voice "voice/12-scene_12-215.ogg" #Raine (Nat)
    mc "Yeah, me too,"

    voice "voice/12-scene_12-216.ogg" #Leona (Dot)
    le "Well, I'm ready to see your home planet."

    voice "voice/12-scene_12-217.ogg" #Leona (Dot)
    le "Maybe after we stay there for a while, you can show me more planets!"

    voice "voice/12-scene_12-218.ogg" #Raine (Nat)
