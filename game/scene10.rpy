label scene_10:
    ...
    voice "voice/10-scene_10-1.ogg" #Leona (Dot)
    le "Careful, there's a low hanging rock here."

    voice "voice/10-scene_10-2.ogg" #Raine (Nat)
    mc "Wonderful, as if I didn't need another lump."

    voice "voice/10-scene_10-3.ogg" #Leona (Dot)
    ...
    voice "voice/10-scene_10-7.ogg" #Leona (Dot)
    le "You keep saying that. What's a 'goat'?"

    voice "voice/10-scene_10-8.ogg" #Raine (Nat)
    mc "A voracious horned devil."

    voice "voice/10-scene_10-9.ogg" #Leona (Dot)
    le "What's a devil?"
    ...
    voice "voice/10-scene_10-12.ogg" #Leona (Dot)
    ...
    voice "voice/10-scene_10-13.ogg" #Leona (Dot)
    ...
    voice "voice/10-scene_10-15.ogg" #Leona (Dot)
    le "Hehe, you remind me of a Haxine when you kick like that."

    voice "voice/10-scene_10-16.ogg" #Raine (Nat)
    ...
    voice "voice/10-scene_10-18.ogg" #Leona (Dot)
    ...
    voice "voice/10-scene_10-23.ogg" #Leona (Dot)
    ...
    voice "voice/10-scene_10-27.ogg" #Leona (Dot)
    ...
    voice "voice/10-scene_10-30.ogg" #Leona (Dot)
    ...
    voice "voice/10-scene_10-34.ogg" #Leona (Dot)
    le "You did it, it's open!"

    voice "voice/10-scene_10-35.ogg" #Raine (Nat)
    mc "Awesome,  just let me get this battery back where it belongs and-"

    voice "voice/10-scene_10-36.ogg" #Raine (Nat)
    mc "-Leona?"

    voice "voice/10-scene_10-37.ogg" #Raine (Nat)
    mc "Where'd you go?"

    voice "voice/10-scene_10-38.ogg" #Leona (Dot)
    le "Just gonna take a look see~"

    voice "voice/10-scene_10-39.ogg" #Raine (Nat)
    ...
    voice "voice/10-scene_10-45.ogg" #Raine (Nat)
    mc "Did you break it?"

    voice "voice/10-scene_10-46.ogg" #Leona (Dot)
    le "Mmmaybe."

    #scene, cave, the lights come back on

    voice "voice/10-scene_10-47.ogg" #Raine (Nat)
    mc "Anything good?"

    voice "voice/10-scene_10-48.ogg" #Leona (Dot)
    le "Oh yeah. You're gonna love this."

    voice "voice/10-scene_10-49.ogg" #Leona (Dot)
    ...
    voice "voice/10-scene_10-51.ogg" #Leona (Dot)
    le "So, you think you'll find your parts?"

    voice "voice/10-scene_10-52.ogg" #Raine (Nat)
    ...
    voice "voice/10-scene_10-54.ogg" #Leona (Dot)
    le "And the best part, you can tell us what they are and how to use them!"

    voice "voice/10-scene_10-55.ogg" #Leona (Dot)
    le "This is incredible!"

    voice "voice/10-scene_10-56.ogg" #Leona (Dot)
    le "What's this?!"
    ...
    voice "voice/10-scene_10-60.ogg" #Raine (Nat)
    ...
    voice "voice/10-scene_10-62.ogg" #Raine (Nat)
    mc "Leona?"

    na "Leona has disappeared back into the labyrinth and isn't answering me."

    voice "voice/10-scene_10-63.ogg" #Raine (Nat)
    ...
    voice "voice/10-scene_10-90.ogg" #Leona (Dot)
    le "Why not stay with me now and bring us with you?"

    voice "voice/10-scene_10-91.ogg" #Raine (Nat)
    mc "It's not that simple."

    voice "voice/10-scene_10-92.ogg" #Raine (Nat)
    mc "Please, trust me when I say if I stay here I will never be able to find human space again."

    voice "voice/10-scene_10-93.ogg" #Raine (Nat)
    mc "But.."

    voice "voice/10-scene_10-94.ogg" #Leona (Dot)
    le "But?"

    voice "voice/10-scene_10-95.ogg" #Raine (Nat)
    mc "But if I go back, using the information I've gathered-"

    voice "voice/10-scene_10-96.ogg" #Raine (Nat)
    mc "-Humanity will find Fireside again."

    voice "voice/10-scene_10-97.ogg" #Raine (Nat)
    mc "Beyond a shadow of a doubt, we can find this planet without the wormhole."

    voice "voice/10-scene_10-98.ogg" #Leona (Dot)
    le "But you'll still have to leave."

    voice "voice/10-scene_10-99.ogg" #Leona (Dot)
    le "And I'll be alone again until you come back."

    voice "voice/10-scene_10-100.ogg" #Leona (Dot)
    ...
    voice "voice/10-scene_10-101.ogg" #Leona (Dot)
    le "I was excited to meet you."

    na "For a moment, I don't know how to react."

    voice "voice/10-scene_10-102.ogg" #Raine (Nat)
    ...
    voice "voice/10-scene_10-109.ogg" #Raine (Nat)
    mc "Yeah, fly with me once, before I leave."

    voice "voice/10-scene_10-110.ogg" #Leona (Dot)
    le "Raine..."
    ...
    voice "voice/10-scene_10-111.ogg" #Raine (Nat)
    ...
    voice "voice/10-scene_10-117.ogg" #Leona (Dot)
    le "Tonight, we celebrate!"

    voice "voice/10-scene_10-118.ogg" #Raine (Nat)
    mc "Onward?"

    voice "voice/10-scene_10-119.ogg" #Leona (Dot)
    le "ONWARD!"
