label scene_10:
    ...
    #voice "voice/10-scene_10-2.ogg" #Raine (VA Name)
    mc "Wonderful, as if I didn't need another lump."

    #voice "voice/10-scene_10-3.ogg" #Leona (VA Name)
    le "I said I was sorry..."

    #voice "voice/10-scene_10-4.ogg" #Raine (VA Name)
    mc "No, it's fine. We wouldn't be in this mess if I had checked the batteries before we left."

    #voice "voice/10-scene_10-5.ogg" #Leona (VA Name)
    le "Lucky you, I have excellent night vision."

    #voice "voice/10-scene_10-6.ogg" #Raine (VA Name)
    mc "Yeah, yeah, just lead the way you silly billy goat."

    #voice "voice/10-scene_10-7.ogg" #Leona (VA Name)
    le "You keep saying that. What's a 'goat'?"

    #voice "voice/10-scene_10-8.ogg" #Raine (VA Name)
    mc "A voracious horned devil."

    #voice "voice/10-scene_10-9.ogg" #Leona (VA Name)
    le "What's a devil?"

    #voice "voice/10-scene_10-10.ogg" #Raine (VA Name)
    mc "I'll explain later. See anything?"

    #voice "voice/10-scene_10-11.ogg" #Leona (VA Name)
    le "I think we've found somethin'. There's a lot of boxes and techy lookin' stuff all over."

    #voice "voice/10-scene_10-12.ogg" #Leona (VA Name)
    ...
    #voice "voice/10-scene_10-13.ogg" #Leona (VA Name)
    le "Dang, that thing really works when it works, doesn't it?"

    #voice "voice/10-scene_10-14.ogg" #Raine (VA Name)
    ...
    #voice "voice/10-scene_10-15.ogg" #Leona (VA Name)
    le "Hehe, you remind me of a Haxine when you kick like that."

    #voice "voice/10-scene_10-16.ogg" #Raine (VA Name)
    mc "And what, pray tell, is a Haxine?"

    #voice "voice/10-scene_10-17.ogg" #Leona (VA Name)
    le "It's this big, furry beast with 6 legs and giant, flat feet from Dawne."

    #voice "voice/10-scene_10-18.ogg" #Leona (VA Name)
    ...
    #voice "voice/10-scene_10-26.ogg" #Raine (VA Name)
    mc "Huh, your nails are wider at the tip compared to mine."

    #voice "voice/10-scene_10-27.ogg" #Leona (VA Name)
    le "Yeah, they're meant for digging and gripping stuff."

    #voice "voice/10-scene_10-28.ogg" #Leona (VA Name)
    le "My people were mountaineers and farmers. Still are, in a way."

    #voice "voice/10-scene_10-29.ogg" #Raine (VA Name)
    mc "That's funny, mine were persistence hunters and tree climbers."

    #voice "voice/10-scene_10-30.ogg" #Leona (VA Name)
    le "Ooh, so we both have gripping power."

    #voice "voice/10-scene_10-31.ogg" #Raine (VA Name)
    mc "And stubbornness."

    #voice "voice/10-scene_10-32.ogg" #Raine (VA Name)
    ...
    #voice "voice/10-scene_10-34.ogg" #Leona (VA Name)
    le "You did it, it's open!"

    #voice "voice/10-scene_10-35.ogg" #Raine (VA Name)
    mc "Awesome,  just let me get this battery back where it belongs and-"

    #voice "voice/10-scene_10-36.ogg" #Raine (VA Name)
    mc "-Leona?"

    #voice "voice/10-scene_10-37.ogg" #Raine (VA Name)
    mc "Where'd you go?"

    #voice "voice/10-scene_10-38.ogg" #Leona (VA Name)
    le "Just gonna take a look see~"

    #voice "voice/10-scene_10-39.ogg" #Raine (VA Name)
    ...
    #voice "voice/10-scene_10-42.ogg" #Leona (VA Name)
    le "Uuuhh, yeah. There was a box."

    #voice "voice/10-scene_10-43.ogg" #Raine (VA Name)
    mc "...And now?"

    #voice "voice/10-scene_10-44.ogg" #Leona (VA Name)
    le "Now it's sorta... not a box?"

    #voice "voice/10-scene_10-45.ogg" #Raine (VA Name)
    mc "Did you break it?"

    #voice "voice/10-scene_10-46.ogg" #Leona (VA Name)
    le "Mmmaybe."

    #scene, cave, the lights come back on

    #voice "voice/10-scene_10-47.ogg" #Raine (VA Name)
    mc "Anything good?"

    #voice "voice/10-scene_10-48.ogg" #Leona (VA Name)
    le "Oh yeah. You're gonna love this."

    #voice "voice/10-scene_10-49.ogg" #Leona (VA Name)
    le "Get in here already!"

    #scene shift, deep cave, looks like a storage bay

    #voice "voice/10-scene_10-50.ogg" #Raine (VA Name)
    mc "Holy cow!"

    #voice "voice/10-scene_10-51.ogg" #Leona (VA Name)
    le "So, you think you'll find your parts?"

    #voice "voice/10-scene_10-52.ogg" #Raine (VA Name)
    mc "I'd be shocked if I didn't... Look at all this!"

    #voice "voice/10-scene_10-53.ogg" #Raine (VA Name)
    mc "I don't know if you guys have developed even half of this technology yet, this could be a massive discovery."

    #voice "voice/10-scene_10-54.ogg" #Leona (VA Name)
    le "And the best part, you can tell us what they are and how to use them!"

    #voice "voice/10-scene_10-55.ogg" #Leona (VA Name)
    le "This is incredible!"

    #voice "voice/10-scene_10-56.ogg" #Leona (VA Name)
    le "What's this?!"

    #voice "voice/10-scene_10-57.ogg" #Leona (VA Name)
    le "And this?!"

    na "While Leona bounds through shelf after shelf of treasures, I notice something in the corner near the door."

    #voice "voice/10-scene_10-58.ogg" #Raine (VA Name)
    ...
    #voice "voice/10-scene_10-59.ogg" #Raine (VA Name)
    mc "I found those chips I was telling you about. There's a bunch of em too."

    #voice "voice/10-scene_10-60.ogg" #Raine (VA Name)
    ...
    #voice "voice/10-scene_10-61.ogg" #Raine (VA Name)
    mc "Wait a minute."

    #voice "voice/10-scene_10-62.ogg" #Raine (VA Name)
    mc "Leona?"

    na "Leona has disappeared back into the labyrinth and isn't answering me."

    #voice "voice/10-scene_10-63.ogg" #Raine (VA Name)
    mc "Come out, come out, wherever you are."

    #voice "voice/10-scene_10-64.ogg" #Leona (VA Name)
    le "Don't wanna."

    #voice "voice/10-scene_10-65.ogg" #Raine (VA Name)
    mc "I'm not mad."

    #voice "voice/10-scene_10-66.ogg" #Leona (VA Name)
    le "I'm sorry..."

    #voice "voice/10-scene_10-67.ogg" #Raine (VA Name)
    ...
    #voice "voice/10-scene_10-70.ogg" #Leona (VA Name)
    le "No dying!"

    #voice "voice/10-scene_10-71.ogg" #Leona (VA Name)
    le "I don't-"

    #voice "voice/10-scene_10-72.ogg" #Leona (VA Name)
    le "- I don't want you to leave so soon is all."

    na "Leona peels open her bag and fishes out I.O.S.C. Chips."

    #voice "voice/10-scene_10-73.ogg" #Raine (VA Name)
    mc "Here, I'll trade ya."

    na "I take off Leona's gloves and offer them up."

    #voice "voice/10-scene_10-74.ogg" #Raine (VA Name)
    mc "Your gloves for the spare parts. Fair, right?"

    #voice "voice/10-scene_10-75.ogg" #Leona (VA Name)
    le "...I guess."

    #voice "voice/10-scene_10-76.ogg" #Raine (VA Name)
    mc "So?"

    #voice "voice/10-scene_10-77.ogg" #Leona (VA Name)
    le "...So..."
    ...
    #voice "voice/10-scene_10-101.ogg" #Leona (VA Name)
    le "I was excited to meet you."

    na "For a moment, I don't know how to react."

    #voice "voice/10-scene_10-102.ogg" #Raine (VA Name)
    ...
    #voice "voice/10-scene_10-109.ogg" #Raine (VA Name)
    mc "Yeah, fly with me once, before I leave."

    #voice "voice/10-scene_10-110.ogg" #Leona (VA Name)
    le "Raine..."
