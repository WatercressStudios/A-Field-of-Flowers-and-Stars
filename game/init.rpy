...
init:
    ...
    init python:
        ...
        MapEmote('le happyspeaking a2', 'le hip base arms_pout tail_default mdo_default ec_default brow_up')
        MapEmote('le happyspeaking a3', 'le hip base arms_raised tail_default mdo_default ed_default brow_up')
        ...
        MapEmote('le frustratedshout', 'le angry base arms_default mdo_default ec_default brow_default')
        ...
        MapEmote('mc gentlehandtalk', 'mc normal armraised mdo_default ed_default brow_sad')
