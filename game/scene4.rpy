label scene_4:
    ...
    #voice "voice/4-scene_4-1.ogg" #Leona (VA Name)
    le "So, how's it look?"
    na "Leona snaps me out of my thoughts as I rest my eyes on what's left of my ship."
    #voice "voice/4-scene_4-2.ogg" #Raine (VA Name)
    mc "Oh... oh god, it's terrible!"
    #voice "voice/4-scene_4-3.ogg" #Leona (VA Name)
    ...
    #voice "voice/4-scene_4-20.ogg" #Leona (VA Name)
    le "..."
    #voice "voice/4-scene_4-21.ogg" #Leona (VA Name)
    le "This is really amazing stuff, even when it's in shambles."
    #voice "voice/4-scene_4-22.ogg" #Leona (VA Name)
    le "I never could have imagined this type of metal could be used like this..."
    #voice "voice/4-scene_4-23.ogg" #Leona (VA Name)
    le "...or that this shape would make for a good space ship..."
    #voice "voice/4-scene_4-24.ogg" #Leona (VA Name)
    le "...or that... or..."
    #voice "voice/4-scene_4-25.ogg" #Leona (VA Name)
    le "..."
    #voice "voice/4-scene_4-26.ogg" #Leona (VA Name)
    le "...oops."
    #voice "voice/4-scene_4-27.ogg" #Leona (VA Name)
    le "That was the part Raine just fixed, wasn't it?"
    #voice "voice/4-scene_4-28.ogg" #Leona (VA Name)
    le "Well, it didn't seem like she had much trouble with it, so I'm sure she can just do it again."
    #voice "voice/4-scene_4-29.ogg" #Leona (VA Name)
    ...
    #voice "voice/4-scene_4-30.ogg" #Raine (VA Name)
    mc "What's wrong? Everything okay?"
    #voice "voice/4-scene_4-31.ogg" #Leona (VA Name)
    le "Yeah! Totally! Um, actually no, it's not..."
    #voice "voice/4-scene_4-32.ogg" #Raine (VA Name)
    mc "Leona?"
    #voice "voice/4-scene_4-33.ogg" #Leona (VA Name)
    ...
    #voice "voice/4-scene_4-34.ogg" #Leona (VA Name)
    le "Oh yeah, did you find any useful tools?"
    #voice "voice/4-scene_4-35.ogg" #Raine (VA Name)
    ...
    na "Juneau..."
    #voice "voice/4-scene_4-41.ogg" #Leona (VA Name)
    le "Did you hear me? Helloooo?"
    #voice "voice/4-scene_4-42.ogg" #Raine (VA Name)
    mc "Oh! Ah, what?"
    #voice "voice/4-scene_4-43.ogg" #Leona (VA Name)
    le "I asked if you wanted dinner. Are you okay?"
    #voice "voice/4-scene_4-44.ogg" #Raine (VA Name)
    mc "Yeah, just thinking about the ship."
    #voice "voice/4-scene_4-45.ogg" #Leona (VA Name)
    le "You said you'd have trouble if the software was busted. I thought you'd know how to simply redo it."
    #voice "voice/4-scene_4-46.ogg" #Raine (VA Name)
    ...
    #voice "voice/4-scene_4-50.ogg" #Raine (VA Name)
    mc "Well, we had our fights, but she was the closest I had to family."
    #voice "voice/4-scene_4-51.ogg" #Raine (VA Name)
    ...
    #voice "voice/4-scene_4-52.ogg" #Raine (VA Name)
    mc "This sucks."
    #voice "voice/4-scene_4-53.ogg" #Leona (VA Name)
    le "Yeah..."
    #voice "voice/4-scene_4-54.ogg" #Leona (VA Name)
    le "But!"
    #voice "voice/4-scene_4-55.ogg" #Raine (VA Name)
    ...
    #voice "voice/4-scene_4-64.ogg" #Leona (VA Name)
