label scene_4:
    ...
    #voice "voice/4-scene_4-8.ogg" #Raine (Nat)
    ...
    #voice "voice/4-scene_4-22.ogg" #Leona (Dot)
    ...
    #voice "voice/4-scene_4-24.ogg" #Leona (Dot)
    le "...or that... or..."
    ...
    #voice "voice/4-scene_4-30.ogg" #Raine (Nat)
    ...
    #voice "voice/4-scene_4-34.ogg" #Leona (Dot)
    le "Oh yeah, did you find any useful tools?"

    #voice "voice/4-scene_4-35.ogg" #Raine (Nat)
    ...
    #voice "voice/4-scene_4-41.ogg" #Leona (Dot)
    ...
    #voice "voice/4-scene_4-44.ogg" #Raine (Nat)
    mc "Yeah, just thinking about the ship."

    #voice "voice/4-scene_4-45.ogg" #Leona (Dot)
    ...
    #voice "voice/4-scene_4-47.ogg" #Leona (Dot)
    le "So what's so important about the program?"

    #voice "voice/4-scene_4-48.ogg" #Raine (Nat)
    ...
    #voice "voice/4-scene_4-51.ogg" #Raine (Nat)
    ...
    #voice "voice/4-scene_4-52.ogg" #Raine (Nat)
    mc "This sucks."

    #voice "voice/4-scene_4-53.ogg" #Leona (Dot)
    le "Yeah..."
    ...
    #voice "voice/4-scene_4-59.ogg" #Leona (Dot)
    ...
    #voice "voice/4-scene_4-63.ogg" #Raine (Nat)
    ...
    #voice "voice/4-scene_4-64.ogg" #Leona (Dot)
    ...
    #voice "voice/4-scene_4-65.ogg" #Leona (Dot)
    le "Well!"
    na "Leona's sudden change of tone catches me off guard."

    #voice "voice/4-scene_4-66.ogg" #Leona (Dot)
    ...
    #voice "voice/4-scene_4-69.ogg" #Raine (Nat)
