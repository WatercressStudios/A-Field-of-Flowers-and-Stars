label scene_11:
    ...
    #voice "voice/11-scene_11-1.ogg" #Leona (VA Name)
    ...
    #voice "voice/11-scene_11-8.ogg" #Raine (VA Name)
    mc "Getting a little cold?"

    #voice "voice/11-scene_11-9.ogg" #Leona (VA Name)
    ...
    #voice "voice/11-scene_11-10.ogg" #Leona (VA Name)
    le "You're the best thing that's happened to me, Raine."

    #voice "voice/11-scene_11-11.ogg" #Leona (VA Name)
    le "When I first found you all tangled up in that tree, I have to admit, I was very curious!"

    #voice "voice/11-scene_11-12.ogg" #Leona (VA Name)
    le "And a little nervous, too."

    #voice "voice/11-scene_11-13.ogg" #Leona (VA Name)
    le "But you were always so kind to me."

    #voice "voice/11-scene_11-14.ogg" #Leona (VA Name)
    le "Not everyone can handle how..."

    #voice "voice/11-scene_11-15.ogg" #Raine (VA Name)
    mc "Insatiable?"

    #voice "voice/11-scene_11-16.ogg" #Leona (VA Name)
    le "{i}Adventurous{/i} as I can be."

    #voice "voice/11-scene_11-17.ogg" #Leona (VA Name)
    le "But you indulged me! Very few can do that for so long."

    #voice "voice/11-scene_11-18.ogg" #Leona (VA Name)
    ...
    #voice "voice/11-scene_11-19.ogg" #Raine (VA Name)
