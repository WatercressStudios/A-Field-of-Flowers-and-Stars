label scene_7:
    ...
    #voice "voice/7-scene_7-6.ogg" #Raine (Nat)
    mc "..."
    ...
    #voice "voice/7-scene_7-11.ogg" #Raine (Nat)
    ...
    #voice "voice/7-scene_7-13.ogg" #Leona (Dot)
