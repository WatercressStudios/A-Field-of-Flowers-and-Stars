...
screen about():
    ...
    use game_menu(_(""), scroll="viewport"):
        ...
        vbox:
            ...
            text _("{i}A Field of Flowers and Stars{/i} was developed for Yurijam 2019 by Watercress Studios in collaboration with Somnova Studios and Sarchalen Visual Media. If you loved this game, check out our {a=https://watercressstudios.com/}official website{/a}, {a=http://somnovastudios.org/}Somnova Studios{/a}, and {a=https://sarchalen.itch.io/}Sarchalen Visual Media{/a} or go straight to our {a=https://watercress.itch.io/}itch.io page{/a} for more of our projects. Also, we have a {a=https://store.steampowered.com/developer/Watercress/}Steam page{/a} where you can download and play several of our previously published visual novels.\n\nYou can also follow the team members on twitter to keep up to date with new studio releases and experience their artwork and other talents.\n\n{a=https://twitter.com/Wolf_GameDev}Tristan 'Wolf' Barber{/a} (Director, Story Writer, Editor, Sound Editor)\n\n{a=https://m.imdb.com/name/nm7026286/}Kevin Bomer{/a} (Director, Story Writer, Scripting)\n\n{a=https://twitter.com/Hamadyne}Hamadyne{/a} (Story Writer)\n\n{a=https://twitter.com/Hoakkun}A.D. 'Hoa' Hemingway{/a} (Story Writer, Scripting)\n\nMonochrome (Story Writer)\n\n{a=https://twitter.com/Zodai_Stryde}Zodai{/a} (Story Writer, Story Concept, Editor, Scripting)\n\n{a=https://twitter.com/alchworks}TheAlchemyst{/a} (Editing Director, Cinematics Directing, Marketing Director, Logo Design)\n\n{a=https://twitter.com/Paul__Robins}Paul Robbins{/a} (Music Director, Sound Design, Sound Editor, Audio)\n\n{a=https://twitter.com/KartProwler}Kart Prowler{/a} (Sprite, CG, Concept Art)\n\n{a=https://twitter.com/Drazillion}Alison 'Draz' Huang{/a} (BG Art)\n\n{a=https://twitter.com/delete_wei}Wei Yuan Lee{/a} (Editor, Scripting)\n\n{a=https://kp1n.bandcamp.com/}Kierious{/a} (Music)\n\n{a=https://speedyspcfan.bandcamp.com/releases}Noah 'Speedy' Aman{/a} (Music)\n\n{a=https://twitter.com/JaeJaeAgogo}Jae{/a} (Music)\n\n{a=https://twitter.com/TheVoiderling}Voiderling{/a} (Concept Art, BG art)\n\n{a=https://twitter.com/liah0227}Liah{/a} (Concept Art)\n\n{a=https://www.deviantart.com/erezu-kun}Erezu{/a} (BG Art)\n\n{a=https://twitter.com/sagittaeri}Sagittaeri{/a} (UI Design, Scripting Tools)\n\n{a=https://twitter.com/Happinessplus__}Happiness+{/a} (Programming Director)\n\n{a=https://twitter.com/DreadLindwyrm}Steve/DreadLindwyrm{/a} (Development Director)\n\nGeneral (Scripting)\n\n{a=https://www.deviantart.com/ebagigi}Gabriel 'Ebagigi'{/a} (Scripting)\n\n{a=https://twitter.com/Meyvol}Meyvol{/a} (Scripting)\n\n{a=https://twitter.com/SandraMJdev}Sandra 'SandraMJ' Molina{/a} (Voice Direction)\n\n{a=https://twitter.com/Dottovuu}Dottovu{/a} (VA of Leona)\n\nNatalie (VA of Raine)\n\n{a=https://twitter.com/homulily}Lily Lammers{/a} (VA of Juneau)\n\n{a=https://twitter.com/Bodo1215}Bodo{/a} (Marketing)\n\n""Made with {a=https://www.renpy.org/}Ren'Py{/a} [renpy.version_only].\n\n[renpy.license!t]")
