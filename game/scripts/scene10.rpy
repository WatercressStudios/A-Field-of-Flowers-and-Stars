label scene_10:
    ...
    #voice "voice/10-scene_10-46.ogg" #Raine (Nat)
    ...
    #voice "voice/10-scene_10-51.ogg" #Raine (Nat)
    mc "That's when we found out about the radiation."

    #voice "voice/10-scene_10-52.ogg" #Leona (Dot)
    le "And you didn't ask me because we'd already..."

    #voice "voice/10-scene_10-53.ogg" #Raine (Nat)
    mc "None of that matters right now. We have to act, now."

    #voice "voice/10-scene_10-54.ogg" #Raine (Nat)
    mc "It's only going to get a lot worse."

    #voice "voice/10-scene_10-55.ogg" #Raine (Nat)
    mc "A handful of minutes could be all it takes."

    #voice "voice/10-scene_10-56.ogg" #Raine (Nat)
    mc "Juneau could be the first to go. Her systems are going to start scrambling the worse the radiation gets."

    #voice "voice/10-scene_10-57.ogg" #Leona (Dot)
    le "This is a nightmare... Come on, let's go talk to her. I have an idea."

    #voice "voice/10-scene_10-58.ogg" #Raine (Nat)
    mc "Thank God, you're a lifesaver."

    na "Literally."

    #voice "voice/10-scene_10-59.ogg" #Raine (Nat)
    mc "And Leona?"

    #voice "voice/10-scene_10-60.ogg" #Leona (Dot)
    le "Hmm?"

    #voice "voice/10-scene_10-61.ogg" #Raine (Nat)
    mc "I… I really am sorry."

    #voice "voice/10-scene_10-62.ogg" #Leona (Dot)
    le "We can discuss this later. There's no time to waste."

    #voice "voice/10-scene_10-63.ogg" #Leona (Dot)
    ...
    #voice "voice/10-scene_10-64.ogg" #Leona (Dot)
    le "Raine, hurry up! And don't forget to close the door!"

    #voice "voice/10-scene_10-65.ogg" #Raine (Nat)
    mc "Coming! On my way!"

    #ART Ship in Garage BG

    #voice "voice/10-scene_10-66.ogg" #Juneau (Lily)
    ju "Could you two dilly-dally around any longer!?"

    #voice "voice/10-scene_10-67.ogg" #Juneau (Lily)
    ju "A bit of an update while you were gone, I'm kinda basically {b}fucked{/b}!"

    #voice "voice/10-scene_10-68.ogg" #Juneau (Lily)
    ...
    #voice "voice/10-scene_10-84.ogg" #Leona (Dot)
    ...
    #voice "voice/10-scene_10-85.ogg" #Raine (Nat)
    mc "...Alright, that should do it."

    #VFX Juneau powers up/sprite fades in

    #voice "voice/10-scene_10-86.ogg" #Juneau (Lily)
    ju "Yay! Thanks for not getting me killed!"

    #voice "voice/10-scene_10-87.ogg" #Raine (Nat)
    ...
    #voice "voice/10-scene_10-93.ogg" #Leona (Dot)
    le "Locate your ship. We're having it moved out to the mountain range."

    #voice "voice/10-scene_10-94.ogg" #Juneau (Lily)
    ju "Aye, I see it! What's the plan?"

    #voice "voice/10-scene_10-95.ogg" #Leona (Dot)
