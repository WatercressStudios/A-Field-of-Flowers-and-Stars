label scene_4:
    ...
    show le sad_lee at le_side with dissolve
    #voice "voice/4-scene_4-1.ogg" #Leona (Dot)
    le "So, how's it look?"
    na "Leona snaps me out of my thoughts as I rest my eyes on what's left of my ship."
    #how mc grumpy at ri_side with dissolve
    #voice "voice/4-scene_4-2.ogg" #Raine (Nat)
    mc "Oh man, what a stinking mess!"
    "I run over, pushing aside some people investigating it. They shoot me dirty looks, but upon seeing Leona, they take the hint and leave."
