...
# ART SHIP FOREGROUND, GARAGE BACKGROUND
    ...
    show ju concerned a1 at hologram:
        stage_right
    #voice "voice/5-default-35.ogg" #Juneau (Lily)
    ju "...Huh?"
    ...
    #voice "voice/5-default-39.ogg" #Juneau (Lily)
    ju snarky a1 "Hi! Thanks a bundle for the save. Those horns real?"

    #voice "voice/5-default-40.ogg" #Leona (Dot)
    le questioning a1 "Uuh, yes?"


    #voice "voice/5-default-41.ogg" #Juneau (Lily)
    ...
    #voice "voice/5-default-48.ogg" #Juneau (Lily)
    ju snarky a1 "Pay attention to me, dammit!"


    #voice "voice/5-default-49.ogg" #Leona (Dot)
...
# VFX JUNEAU SPRITE GLITCHING A bit
    show ju red worried a1 at stage_right with vpunch:
        ...
        easein .1 additive 7
        easein .2 additive 0
    #voice "voice/5-default-60.ogg" #Juneau (Lily)
    ju "Z-Zhtop that!"
    play sound "sfx/Kicking panel.ogg"
