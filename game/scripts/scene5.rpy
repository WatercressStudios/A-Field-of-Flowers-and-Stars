label scene_5:
 ...
 # ART GARAGE BG (with added boxes of junk)
    ...
    voice "voice/5-scene_5-6.ogg" #Leona (Dot)
    ...
    voice "voice/5-scene_5-8.ogg" #Raine (Nat)
    mc "Give my thanks to your crew too."

    voice "voice/5-scene_5-9.ogg" #Leona (Dot)
    le "Hehe!"

    voice "voice/5-scene_5-10.ogg" #Leona (Dot)
    le "So, what's on the agenda today?"

    voice "voice/5-scene_5-11.ogg" #Raine (Nat)
    mc "...I think it's time we found the other survivor."

    voice "voice/5-scene_5-12.ogg" #Leona (Dot)
    le "Other survivor?"

    voice "voice/5-scene_5-13.ogg" #Leona (Dot)
    le "Do you mean your AI friend?"

    voice "voice/5-scene_5-14.ogg" #Leona (Dot)
    ...
    voice "voice/5-scene_5-16.ogg" #Leona (Dot)
    le "How do we do that?"

    voice "voice/5-scene_5-17.ogg" #Raine (Nat)
    ...
    voice "voice/5-scene_5-19.ogg" #Raine (Nat)
    mc "Did you find any of my tools earlier?"

    voice "voice/5-scene_5-20.ogg" #Leona (Dot)
    ...
    voice "voice/5-scene_5-26.ogg" #Raine (Nat)
    ...
    voice "voice/5-scene_5-29.ogg" #Raine (Nat)
    mc "Hold your applause, please!"

    voice "voice/5-scene_5-30.ogg" #Leona (Dot)
    le "Encore!"

    voice "voice/5-scene_5-31.ogg" #Raine (Nat)
...
# ART SHIP FOREGROUND, GARAGE BACKGROUND
    ...
    voice "voice/5-scene_5-34.ogg" #Leona (Dot)
    le "Almost got it!"
    ...
    voice "voice/5-scene_5-36.ogg" #Juneau (Lily)
    ju "...Huh?"

    voice "voice/5-scene_5-37.ogg" #Juneau (Lily)
    ...
    voice "voice/5-scene_5-46.ogg" #Juneau (Lily)
    ju "Oh boohoo, I'm Raine and I came out unscathed from my crash, oh woe is me!"

    voice "voice/5-scene_5-47.ogg" #Juneau (Lily)
    ...
    voice "voice/5-scene_5-49.ogg" #Juneau (Lily)
    ju "Pay attention to me, dammit!"

    voice "voice/5-scene_5-50.ogg" #Leona (Dot)
    ...
    voice "voice/5-scene_5-52.ogg" #Juneau (Lily)
    ...
    voice "voice/5-scene_5-53.ogg" #Juneau (Lily)
    ju "Hey, you're not allowed to slack now that you have me back, lazy ass."

    voice "voice/5-scene_5-54.ogg" #Raine (Nat)
    mc "Is that you volunteering for something?"

    voice "voice/5-scene_5-55.ogg" #Juneau (Lily)
    ...
    voice "voice/5-scene_5-56.ogg" #Juneau (Lily)
    ...
    voice "voice/5-scene_5-57.ogg" #Raine (Nat)
    mc "Pffffft-"

    na "As always, Juneau caught me off guard."

    voice "voice/5-scene_5-58.ogg" #Juneau (Lily)
...
# VFX JUNEAU SPRITE GLITCHING A bit
    ...
    voice "voice/5-scene_5-61.ogg" #Juneau (Lily)
    ju "Z-Zhtop that!"

    voice "voice/5-scene_5-62.ogg" #Juneau (Lily)
    ju "This is abuse! Help! Bad touch! Stranger danger!"

    na "I think Juneau got the message, though Leona is looking a little lost."

    voice "voice/5-scene_5-63.ogg" #Raine (Nat)
    mc "Settle down already, we got shit to do."

    voice "voice/5-scene_5-64.ogg" #Juneau (Lily)
    ...
    voice "voice/5-scene_5-66.ogg" #Raine (Nat)
    ...
    voice "voice/5-scene_5-70.ogg" #Leona (Dot)
    ...
    voice "voice/5-scene_5-72.ogg" #Raine (Nat)
    mc "Look, it's all rusty and caked in dirt too."

    voice "voice/5-scene_5-73.ogg" #Leona (Dot)
    le "So it's not human? I don't get it."

    voice "voice/5-scene_5-74.ogg" #Raine (Nat)
    ...
    voice "voice/5-scene_5-75.ogg" #Raine (Nat)
    ...
    voice "voice/5-scene_5-78.ogg" #Juneau (Lily)
    ju "Whaddya mean 'gone?'"

    voice "voice/5-scene_5-79.ogg" #Raine (Nat)
    ...
    voice "voice/5-scene_5-86.ogg" #Raine (Nat)
    ...
    voice "voice/5-scene_5-96.ogg" #Juneau (Lily)
...
# ART JUNEAU SPRITE VANISHES
    ...
    voice "voice/5-scene_5-103.ogg" #Raine (Nat)
    mc "Maybe I'll buy her a present when we get home to make up for all this."

    voice "voice/5-scene_5-104.ogg" #Leona (Dot)
    ...
    voice "voice/5-scene_5-108.ogg" #Raine (Nat)
    ...
    voice "voice/5-scene_5-109.ogg" #Leona (Dot)
    le "What was it called?"

    voice "voice/5-scene_5-110.ogg" #Raine (Nat)
    ...
    voice "voice/5-scene_5-124.ogg" #Raine (Nat)
    ...
    voice "voice/5-scene_5-125.ogg" #Leona (Dot)
    le "But it'll still be awhile, won't it?"

    voice "voice/5-scene_5-126.ogg" #Raine (Nat)
    ...
    voice "voice/5-scene_5-130.ogg" #Raine (Nat)
    mc "Looks like we're going exploring then."

    voice "voice/5-scene_5-131.ogg" #Leona (Dot)
    le "Hell yeah!"

    voice "voice/5-scene_5-132.ogg" #Raine (Nat)
    mc "...Hell?"

    voice "voice/5-scene_5-133.ogg" #Leona (Dot)
    le "Oh, do you not know that expression?"

    voice "voice/5-scene_5-134.ogg" #Raine (Nat)
    mc "No, I do. I'm just surprised you know it."

    voice "voice/5-scene_5-135.ogg" #Leona (Dot)
