label scene_1:
    ...
    #voice "voice/1-scene_1-10.ogg" #Raine (Nat)
    mc "I do {b}not{/b} sound like that."

    #voice "voice/1-scene_1-11.ogg" #Juneau (Lily)
    ju snarky "You do too!"

    #voice "voice/1-scene_1-12.ogg" #Raine (Nat)
    ...
    #voice "voice/1-scene_1-21.ogg" #Raine (Nat)
    mc "Hahaha."

    #voice "voice/1-scene_1-22.ogg" #Juneau (Lily)
    ju "What?"

    #voice "voice/1-scene_1-23.ogg" #Raine (Nat)
    ...
    #voice "voice/1-scene_1-24.ogg" #Raine (Nat)
    ...
    #voice "voice/1-scene_1-25.ogg" #Juneau (Lily)
    ju "Woah!" with vpunch

    #voice "voice/1-scene_1-26.ogg" #Raine (Nat)
    mc "Juneau, report!"
    ...
    #voice "voice/1-scene_1-29.ogg" #Raine (Nat)
    mc "Damnit! It's a wormhole. We got caught in its well."

    #voice "voice/1-scene_1-30.ogg" #Raine (Nat)
    mc "Forward full thrust. Give me manual control."


    #voice "voice/1-scene_1-31.ogg" #Juneau (Lily)
    ...
    #voice "voice/1-scene_1-32.ogg" #Raine (Nat)
    mc "We're caught in a gravity field. It'll tear the ship apart before we ever break free."

    #voice "voice/1-scene_1-33.ogg" #Raine (Nat)
    mc "We gotta go through."

    #voice "voice/1-scene_1-34.ogg" #Juneau (Lily)
    ...
    #voice "voice/1-scene_1-35.ogg" #Raine (Nat)
    mc "Disengage safety. It's the only way we get out of this."

    #voice "voice/1-scene_1-36.ogg" #Juneau (Lily)
    ju @ red sassy"*sigh* If you kill me, it'll be on your conscience."

    #voice "voice/1-scene_1-37.ogg" #Juneau (Lily)
    ...
    #voice "voice/1-scene_1-38.ogg" #Juneau (Lily)
    ju "How can you be so calm at a time like this? We don't even know where it goes!"

    #voice "voice/1-scene_1-39.ogg" #Raine (Nat)
    mc "We're about to find out."

    #voice "voice/1-scene_1-40.ogg" #Raine (Nat)
    mc "I built this ship to fly, so lets fly."

    #voice "voice/1-scene_1-41.ogg" #Juneau (Lily)
    ju "Ah!"
    ...
    #voice "voice/1-scene_1-42.ogg" #Raine (Nat)
    mc "..."

    #voice "voice/1-scene_1-43.ogg" #Juneau (Lily)
    ju "..."

    #voice "voice/1-scene_1-44.ogg" #Raine (Nat)
    mc "What the fuck was that?"
    #Juneau glitches out
    stop sound4 fadeout 2.0
    play sound5 "sfx/SSL2.ogg" fadein 2.0
    #voice "voice/1-scene_1-45.ogg" #Juneau (Lily)
    ...
    #voice "voice/1-scene_1-46.ogg" #Raine (Nat)
    mc "Shit. Don't wanna go there."

    #voice "voice/1-scene_1-47.ogg" #Raine (Nat)
    mc "Juneau come back!"
    ...
    #voice "voice/1-scene_1-48.ogg" #Juneau (Lily)
