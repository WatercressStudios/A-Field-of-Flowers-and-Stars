label epilogue:
    ...
    #voice "voice/12-epilogue-20.ogg" #Leona (Dot)
    le "Raine, you see that? In the sky?"

    #voice "voice/12-epilogue-21.ogg" #Raine (Nat)
    mc "Huh. Looks like a shooting star."

    #voice "voice/12-epilogue-22.ogg" #Leona (Dot)
    le "It seems... familiar."

    #voice "voice/12-epilogue-23.ogg" #Raine (Nat)
    mc "It's not burning up."

    #voice "voice/12-epilogue-24.ogg" #Raine (Nat)
    mc "I think it's crashing."

    #voice "voice/12-epilogue-25.ogg" #Leona (Dot)
    le "Let's go check it out!"

    #voice "voice/12-epilogue-26.ogg" #Raine (Nat)
    mc "Right behind ya!"
