...
label scene_7: 
    ...
    #voice "voice/7-scene_7-7.ogg" #Leona (Dot)
    le "Think about it; a hidden base inside a cave, things buried underground-"
    #voice "voice/7-scene_7-8.ogg" #Raine (Nat)
    mc questioning2 "Rooms full of bodies?"
    #voice "voice/7-scene_7-9.ogg" #Leona (Dot)
    le concerned "Y-Yeah."
    #voice "voice/7-scene_7-10.ogg" #Raine (Nat)
    ...
    #voice "voice/7-scene_7-12.ogg" #Leona (Dot)
    ...
    #voice "voice/7-scene_7-19.ogg" #Leona (Dot)
    le "And it's not like we can read them anyway."
    #voice "voice/7-scene_7-20.ogg" #Raine (Nat)
    mc satisfied "Actually, I might be able to help with that!"
    #voice "voice/7-scene_7-21.ogg" #Leona (Dot)
    le happy a1 "You can? How?"
    #voice "voice/7-scene_7-22.ogg" #Raine (Nat)
    mc "I can't actually speak your language, remember?"
    #voice "voice/7-scene_7-23.ogg" #Leona (Dot)
    ...
    #voice "voice/7-scene_7-25.ogg" #Leona (Dot)
    le "And it's not like we can read them anyway."
    #voice "voice/7-scene_7-26.ogg" #Raine (Nat)
    mc satisfied "Actually, I might be able to help with that!"
    #voice "voice/7-scene_7-27.ogg" #Leona (Dot)
    le speakingsurprised a1 "You can? How?"
    #voice "voice/7-scene_7-28.ogg" #Raine (Nat)
    mc "I can't actually speak your language, remember?"
    #voice "voice/7-scene_7-29.ogg" #Leona (Dot)
    ...
    #voice "voice/7-scene_7-31.ogg" #Leona (Dot)
    ...
    #SFX - PAGE TURNING
    #voice "voice/7-scene_7-33.ogg" #Raine (Nat)
    ...
    #voice "voice/7-scene_7-36.ogg" #Raine (Nat)
    ...
    #voice "voice/7-scene_7-51.ogg" #Leona (Dot)
    ...
    #voice "voice/7-scene_7-54.ogg" #Raine (Nat)
    mc "You might as well leave a giant arrow pointing straight to it."
    #voice "voice/7-scene_7-55.ogg" #Leona (Dot)
    ...
    #voice "voice/7-scene_7-58.ogg" #Raine (Nat)
    ...
    #voice "voice/7-scene_7-64.ogg" #Leona (Dot)
    le "No, I-"
    #voice "voice/7-scene_7-65.ogg" #Leona (Dot)
    ...
    #voice "voice/7-scene_7-67.ogg" #Raine (Nat)
    ...
    #voice "voice/7-scene_7-69.ogg" #Raine (Nat)
    mc questioning "Leona, what if it's a bomb?"
    #voice "voice/7-scene_7-70.ogg" #Leona (Dot)
    le concerned "A bomb? I don't understand, how can a room be a bomb?"
    #voice "voice/7-scene_7-71.ogg" #Raine (Nat)
    ...
    #voice "voice/7-scene_7-80.ogg" #Raine (Nat)
    ...
    #voice "voice/7-scene_7-95.ogg" #Raine (Nat)
    mc "That could have been the power source we were looking for."
    #voice "voice/7-scene_7-96.ogg" #Raine (Nat)
    ...
    #voice "voice/7-scene_7-101.ogg" #Leona (Dot)
    ...
    #voice "voice/7-scene_7-104.ogg" #Raine (Nat)
    ...
    #voice "voice/7-scene_7-105.ogg" #Raine (Nat)
    ...
    #voice "voice/7-scene_7-111.ogg" #Leona (Dot)
    ...
    #voice "voice/7-scene_7-112.ogg" #Raine (Nat)
    mc neutral "Can we talk about this?"
    #voice "voice/7-scene_7-113.ogg" #Leona (Dot)
    le sad_lee "Um…"
    ...
    #voice "voice/7-scene_7-115.ogg" #Raine (Nat)
    ...
    #voice "voice/7-scene_7-124.ogg" #Leona (Dot)
    le "For a moment I saw you back up in that tree."
    #voice "voice/7-scene_7-125.ogg" #Leona (Dot)
    ...
    #voice "voice/7-scene_7-127.ogg" #Leona (Dot)
    ...
    #voice "voice/7-scene_7-129.ogg" #Leona (Dot)
    ...
    #voice "voice/7-scene_7-132.ogg" #Leona (Dot)
    ...
    le "But-"
    #voice "voice/7-scene_7-135.ogg" #Raine (Nat)
    ...
    #voice "voice/7-scene_7-137.ogg" #Raine (Nat)
    ...
    #voice "voice/7-scene_7-139.ogg" #Raine (Nat)
    mc unimpressed "Get the rocks."
    #voice "voice/7-scene_7-140.ogg" #Leona (Dot)
    ...
    #voice "voice/7-scene_7-142.ogg" #Raine (Nat)
    ...
    #voice "voice/7-scene_7-145.ogg" #Leona (Dot)
    ...
    #voice "voice/7-scene_7-147.ogg" #Leona (Dot)
    ...
    #voice "voice/7-scene_7-148.ogg" #Leona (Dot)
    le speakingsurprised "Oh my god-!"
    #voice "voice/7-scene_7-149.ogg" #Leona (Dot)
    le "What was that?!"
    ...
    #voice "voice/7-scene_7-151.ogg" #Raine (Nat)
    ...
    #voice "voice/7-scene_7-154.ogg" #Raine (Nat)
    mc "Your present. As promised; A little \"thanks\" for all the help."
    #voice "voice/7-scene_7-155.ogg" #Raine (Nat)
    ...
    #
    ###
    #voice "voice/7-scene_7-160.ogg" #Leona (Dot)
    le "Raine?"
    na "Just walking."
    #voice "voice/7-scene_7-161.ogg" #Leona (Dot)
    le sad "R-Raine...?"
    na "Back to my ship."
    #voice "voice/7-scene_7-162.ogg" #Leona (Dot)
    le crying "{b}Raine{/b}?!"
    na "Back to Aster."
    #voice "voice/7-scene_7-163.ogg" #Leona (Dot)
