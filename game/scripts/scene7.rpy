...
label scene_7:
    ...
    #voice "voice/7-scene7-7.ogg" #Leona (Dot)
    le "Think about it; a hidden base inside a cave, things buried underground-"
    #voice "voice/7-scene7-8.ogg" #Raine (Nat)
    mc questioning2 "Rooms full of bodies?"
    #voice "voice/7-scene7-9.ogg" #Leona (Dot)
    le concerned "Y-Yeah."
    #voice "voice/7-scene7-10.ogg" #Raine (Nat)
    ...
    #voice "voice/7-scene7-21.ogg" #Leona (Dot)
    le happy a1 "You can? How?"
    #voice "voice/7-scene7-22.ogg" #Raine (Nat)
    ...
    #voice "voice/7-scene7-31.ogg" #Leona (Dot)
    le concerned "Careful, it might fall apart if you're too rough with them."
    #voice "voice/7-scene7-32.ogg" #Raine (Nat)
    ...
    #voice "voice/7-scene7-60.ogg" #Raine (Nat)
    ...
    #voice "voice/7-scene7-61.ogg" #Leona (Dot)
    le speakingsurprised a1 "W-Well, I don't know about-"
    #voice "voice/7-scene7-62.ogg" #Raine (Nat)
    mc neutral "We found them though!"
    #voice "voice/7-scene7-63.ogg" #Raine (Nat)
    ...
    #voice "voice/7-scene7-64.ogg" #Leona (Dot)
    le "No, I-"
    #voice "voice/7-scene7-65.ogg" #Leona (Dot)
    le "Wait. What are you getting at?"
    #voice "voice/7-scene7-66.ogg" #Raine (Nat)
    mc questioning2 "What if the door is a trap set for whoever wanted to find the smuggled cargo?"
    #voice "voice/7-scene7-67.ogg" #Raine (Nat)
    ...
    #voice "voice/7-scene7-68.ogg" #Raine (Nat)
    ...
    #voice "voice/7-scene7-84.ogg" #Raine (Nat)
    mc questioning "Go on...?"
    #voice "voice/7-scene7-85.ogg" #Leona (Dot)
    le "Promise me you won't be mad?"
    #voice "voice/7-scene7-86.ogg" #Raine (Nat)
    mc annoyed "...That depends, Leona. What are you confessing to?"
    #voice "voice/7-scene7-87.ogg" #Leona (Dot)
    le "That room? With the bodies?"
    #voice "voice/7-scene7-88.ogg" #Leona (Dot)
    le "It uh... It didn't actually, sort of, have... any?"
    na "..."
    #voice "voice/7-scene7-89.ogg" #Raine (Nat)
    mc unimpressed "What?"
    #voice "voice/7-scene7-90.ogg" #Leona (Dot)
    le "I miiight have l-lied..."
    #voice "voice/7-scene7-91.ogg" #Raine (Nat)
    mc upset "Why would you- Wait, what was glowing then?"
    #voice "voice/7-scene7-92.ogg" #Leona (Dot)
    le speakingsurprised a1 "There was a room, but it didn't have any corpses inside."
    #voice "voice/7-scene7-93.ogg" #Raine (Nat)
    mc annoyed "Leona, what did you see?"
    #voice "voice/7-scene7-94.ogg" #Leona (Dot)
    ...
    na "..."
    #voice "voice/7-scene7-114.ogg" #Raine (Nat)
    ...
    le "...I'm sorry…"
    #voice "voice/7-scene7-119.ogg" #Raine (Nat)
    ...
    #voice "voice/7-scene7-138.ogg" #Raine (Nat)
    ...
    #voice "voice/7-scene7-147.ogg" #Leona (Dot)
    ...
    #voice "voice/7-scene7-154.ogg" #Raine (Nat)
    mc "Your present. As promised; A little \"thanks\" for all the help."
    #voice "voice/7-scene7-155.ogg" #Raine (Nat)
    ...
    #
    ###
    #voice "voice/7-scene7-160.ogg" #Leona (Dot)
    le "Raine?"
    na "Just walking."
