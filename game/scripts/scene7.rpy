...
mc "Lovely. I was sort of hoping I'd never see this neck of the woods again."
...
le "Why is there stuff all the way out here when the cave base would suffice?"
le "Think about it; a hidden base inside a cave, things buried underground-"
mc "Rooms full of bodies?"
le "Y-Yeah."
mc "You might be onto something."
le "What's more, why haven't we found anything out in the open?"
le"Was this place really colonized at some point if there are no other structures?"
mc "Assume it wasn't a populated planet then."
mc "What else would someone be doing here, living in a cave and hiding stuff underground so far away?"
le "I'm pretty sure whoever was here before us was a criminal, perhaps a smuggler."
mc "That would make some sense, but it doesn't explain why there's stuff all the way out here."
le "That's just it, isn't it?"
le "We didn't find much of anything in the cave, except some old books."
le "And it's not like we can read them anyway."
mc "Actually, I might be able to help with that!"
le "You can? How?"
mc "I can't actually speak your language, remember?"
le "Oooh, your translator! I didn't think about it, but that must be why you can use the mediapad I gave you."
mc "Yeah, works just as well for the written word. Gimme one of the books and I'll take a look-see."
...
mc "If it can survive in a cave for a thousand years and then make it through your deathtrap of a bike in one piece, I doubt my delicate hands will be enough to leave a scratch."

###
SFX - PAGE TURNING
###

mc "Looks like nothing but random squiggles."
...
mc "Squig- Wait! Here we go, finally kicking in!"
mc "Eh? Looks like a manifest of some sort."
mc "Food, water, all sorts of supplies and components like batteries and computer chips."
mc "The whole thing is just that. Every page a different list. No names, just numbers."
mc "Get me a different one."
le "Here."
mc "...Nope. Just more manifests. Are they all like this?"
...
le "Well, whoever these belonged to obviously didn't care about them."
...
mc "Or they were intending to get rid of evidence of smuggling, thinking nobody would find it there."
le"That leads me back to the stuff we found with your ship though."
...
le "...Huh. That's a really good point."
mc "What if it's not a decoy, but a trap?"
le "A trap? Why would-"
mc "Leona, what about the bodies you found?"
...
mc "That entire cave had to have been a trap. Whoever those people were must have been killed before they could find these manifests!"
le "W-Well, I don't know about-"
mc "We found them though!"
...
mc "What if the door is a trap set for whoever wanted to find the smuggled cargo?"
...
mc "Think about it. A beacon to draw people in, trapped doors to kill off intruders and at the very back of the cave there's a pressurized room."
mc "Leona, what if it's a bomb?"
le "A bomb? I don't understand, how can a room be a bomb?"
mc "I don't know. Maybe there's something inside set to go off as soon as..."
mc "...as soon as..."
mc "...the pressure is released when the door opens."
le "Raine, didn't that hole start making a whistling noise when you pulled that bolt out?"
mc "Crap."
le "What do we do?!"
mc "Absolutely nothing."
le "What? No! A bomb is gonna go off!"
mc "Relax, it can't be that strong."
...
mc "...That depends, Leona. What are you confessing to?"
le "That room? With the bodies?"
le "It uh... It didn't actually, sort of, have... any?"
na "..."
mc "What?"
le "I miiight have l-lied..."
mc "Why would you- Wait, what was glowing then?"
le "There was a room, but it didn't have any corpses inside."
mc "Leona, what did you see?"
...
mc "But why would you...?"
mc "Waaait a second. If there aren't any traps before the door at the back-"
mc "That means the bomb might not be as small as I thought."
le "How big do you think it could be?"
mc "I don't know. Big enough to blow away the entire cave, I imagine."
...
le "A big enough explosion could cause them all to collapse at once!"
mc "Get on the horn, warn everyone to get away from those mountains!"
...
le "This is Captain Leona broadcasting on all emergency channels!"
...
le "...I'm sorry."
mc "But you lied to me. I trusted you, and you lied to me."
le "...I'm sorry…"
...
mc "Is that so?"
mc "And the easiest way to do that is to keep me from leaving."
le "I'm sorry! I was scared!"
mc "That isn't your choice to make."
le "But-"
mc "That isn't your fucking choice to make!"
...
le "I-I don't think I can-"
mc "I don't care. Throw the rock."
...
le "Oh my god-!"
le "What was that?!"
mc "I could do that the whole time. I didn't figure it out until earlier today."
...
mc "That reminds me. I have a gift for you."
...
mc "It's a music player. Brought it with me from Lumin. You just hit the button in the middle when you want to start it."
mc "I had Juneau translate the interface and attach lyrics to all the songs."
le "Raine..."
mc "But, as you know, I won't be needing any more help from now on."
