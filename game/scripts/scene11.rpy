label scene_11:
    ...
    #voice "voice/11-scene_11-7.ogg" #Raine (Nat)
    ...
    #voice "voice/11-scene_11-11.ogg" #Raine (Nat)
    ...
    #voice "voice/11-scene_11-12.ogg" #Leona (Dot)
    ...
    #voice "voice/11-scene_11-23.ogg" #Leona (Dot)
    ...
    #voice "voice/11-scene_11-24.ogg" #Raine (Nat)
    mc "...I understand, and I-"

    #voice "voice/11-scene_11-25.ogg" #Leona (Dot)
    le "There's more."

    #voice "voice/11-scene_11-26.ogg" #Raine (Nat)
    mc "What else could there be? Weren't you just trying to protect me?"

    #voice "voice/11-scene_11-27.ogg" #Leona (Dot)
    le "...I had another selfish reason..."

    #voice "voice/11-scene_11-28.ogg" #Raine (Nat)
    mc "Okay."

    #voice "voice/11-scene_11-29.ogg" #Raine (Nat)
    mc "What was it?"

    #voice "voice/11-scene_11-30.ogg" #Leona (Dot)
    le "When I first realized how much more advanced you are compared to us, I had a bad thought."

    #voice "voice/11-scene_11-31.ogg" #Leona (Dot)
    le "I thought that if we became friends, maybe you'd give us some of your technology."

    #voice "voice/11-scene_11-32.ogg" #Raine (Nat)
    mc "...That's-"

    #voice "voice/11-scene_11-33.ogg" #Leona (Dot)
    le "I'm not done!"

    #voice "voice/11-scene_11-34.ogg" #Leona (Dot)
    le "...I was in awe of you, ever since you arrived. It was amazing to actually have someone like you arrive."

    #voice "voice/11-scene_11-35.ogg" #Leona (Dot)
    ...
    #voice "voice/11-scene_11-46.ogg" #Leona (Dot)
    le "That was my first mistake, thinking you needed my protection. And because of that, I hurt you."

    #voice "voice/11-scene_11-47.ogg" #Leona (Dot)
    le "And I'm sorry for that."

    #voice "voice/11-scene_11-48.ogg" #Leona (Dot)
    le "You have no idea how sorry I am."

    #voice "voice/11-scene_11-49.ogg" #Raine (Nat)
    mc "...Are you done?"

    #voice "voice/11-scene_11-50.ogg" #Leona (Dot)
    le "...Y-Yeah."

    #voice "voice/11-scene_11-51.ogg" #Raine (Nat)
    mc "That's a lot to digest."

    #voice "voice/11-scene_11-52.ogg" #Leona (Dot)
    le "Sorry..."

    #voice "voice/11-scene_11-53.ogg" #Raine (Nat)
    mc "I forgive you, Leona."

    #voice "voice/11-scene_11-54.ogg" #Leona (Dot)
    le "You... do...?"

    #voice "voice/11-scene_11-55.ogg" #Raine (Nat)
    mc "Yeah. For all of it."

    #voice "voice/11-scene_11-56.ogg" #Raine (Nat)
    mc "Even for reading my journal, which you neglected to mention."

    #voice "voice/11-scene_11-57.ogg" #Leona (Dot)
    le "...But?"

    #voice "voice/11-scene_11-58.ogg" #Raine (Nat)
    mc "But nothin'. You understand that?"

    na "I sigh and lightly pat her shoulder."

    #voice "voice/11-scene_11-59.ogg" #Raine (Nat)
    ...
    #voice "voice/11-scene_11-106.ogg" #Raine (Nat)
    mc "Do... Do you have something in mind?"

    #voice "voice/11-scene_11-107.ogg" #Leona (Dot)
    le "I want to help you build another ship"

    #voice "voice/11-scene_11-108.ogg" #Raine (Nat)
    mc "How? I can't use anything here."

    #voice "voice/11-scene_11-109.ogg" #Leona (Dot)
    le "So let's explore the rest of the planet."

    #voice "voice/11-scene_11-110.ogg" #Raine (Nat)
    mc "Is that why you're packing?"

    #voice "voice/11-scene_11-111.ogg" #Leona (Dot)
    le "There has to be something out there, right?"

    #voice "voice/11-scene_11-112.ogg" #Raine (Nat)
    mc "Do you really think you'll find anything?"

    #voice "voice/11-scene_11-113.ogg" #Leona (Dot)
    le "No idea. Does it matter?"

    #voice "voice/11-scene_11-114.ogg" #Raine (Nat)
    mc "It does."

    #voice "voice/11-scene_11-115.ogg" #Leona (Dot)
    le "Why?"

    #voice "voice/11-scene_11-116.ogg" #Raine (Nat)
    mc "Because..."

    #voice "voice/11-scene_11-117.ogg" #Raine (Nat)
    mc "If you can..."

    #voice "voice/11-scene_11-118.ogg" #Raine (Nat)
    mc "I'll be able to pay you back."

    #voice "voice/11-scene_11-119.ogg" #Leona (Dot)
    le "You mean it?"

    #voice "voice/11-scene_11-120.ogg" #Raine (Nat)
    mc "I do."

    #voice "voice/11-scene_11-121.ogg" #Leona (Dot)
    le "What if I don't want to be paid back?"

    #voice "voice/11-scene_11-122.ogg" #Raine (Nat)
    mc "Does it matter?"

    #voice "voice/11-scene_11-123.ogg" #Leona (Dot)
    le "It does."

    #voice "voice/11-scene_11-124.ogg" #Raine (Nat)
    mc "...It would be selfish then."

    #voice "voice/11-scene_11-125.ogg" #Leona (Dot)
    le "I'm okay with that."

    #voice "voice/11-scene_11-126.ogg" #Raine (Nat)
    mc "In that case... do you wanna..."

    #voice "voice/11-scene_11-127.ogg" #Raine (Nat)
    mc "Live... With me? On the new ship?"

    #voice "voice/11-scene_11-128.ogg" #Leona (Dot)
    le "Will it be small?"

    #voice "voice/11-scene_11-129.ogg" #Raine (Nat)
    mc "Probably."

    #voice "voice/11-scene_11-130.ogg" #Leona (Dot)
    le "And cozy?"

    #voice "voice/11-scene_11-131.ogg" #Raine (Nat)
    mc "Sure."

    #voice "voice/11-scene_11-132.ogg" #Leona (Dot)
    le "And until that happens?"

    #voice "voice/11-scene_11-133.ogg" #Raine (Nat)
    mc "We can get to know each other."

    #voice "voice/11-scene_11-134.ogg" #Leona (Dot)
    le "You want me to tell you more stories?"

    #voice "voice/11-scene_11-135.ogg" #Raine (Nat)
    mc "Only if they're about you."

    #voice "voice/11-scene_11-136.ogg" #Leona (Dot)
    le "And what about you?"

    #voice "voice/11-scene_11-137.ogg" #Raine (Nat)
    mc "I can tell you about the stars."

    #voice "voice/11-scene_11-138.ogg" #Leona (Dot)
    le "And you?"

    #voice "voice/11-scene_11-139.ogg" #Raine (Nat)
    mc "And me."

    #voice "voice/11-scene_11-140.ogg" #Leona (Dot)
    le "Promise?"

    #voice "voice/11-scene_11-141.ogg" #Raine (Nat)
    mc "Promise."

    #voice "voice/11-scene_11-142.ogg" #Leona (Dot)
    le "Anything else you want to get off your chest?"

    #voice "voice/11-scene_11-143.ogg" #Raine (Nat)
    mc "...Maybe."

    #voice "voice/11-scene_11-144.ogg" #Leona (Dot)
    le "Tell me."

    #voice "voice/11-scene_11-145.ogg" #Raine (Nat)
    mc "Well."

    #voice "voice/11-scene_11-146.ogg" #Raine (Nat)
    mc "I might..."

    #voice "voice/11-scene_11-147.ogg" #Leona (Dot)
    le "Juuuust?"

    #voice "voice/11-scene_11-148.ogg" #Raine (Nat)
    mc "have a bit of a thing."

    #voice "voice/11-scene_11-149.ogg" #Raine (Nat)
    mc "For... You."

    #ART KissCG3, followed by KissCG4

    #voice "voice/11-scene_11-150.ogg" #Leona (Dot)
    le "I know."

    #voice "voice/11-scene_11-151.ogg" #Raine (Nat)
    ...
    #voice "voice/11-scene_11-152.ogg" #Leona (Dot)
    le "Oh my god, I almost forgot!"

    #voice "voice/11-scene_11-153.ogg" #Raine (Nat)
    mc "L-Leona!?"

    #voice "voice/11-scene_11-154.ogg" #Leona (Dot)
    le "Focus! Ship, radiation, explosion!"

    #voice "voice/11-scene_11-155.ogg" #Raine (Nat)
    mc "Oh crap, what's happening out there?"

    na "Leona scrambles off the couch, and me, and books it to the radio on the table."

    #voice "voice/11-scene_11-156.ogg" #Leona (Dot)
    ...
    #voice "voice/11-scene_11-157.ogg" #Leona (Dot)
    le "Raine! We're in the clear!"

    #voice "voice/11-scene_11-158.ogg" #Raine (Nat)
    mc "Hmm, what? It worked? How do you know if we haven't talked to Juneau?"

    #voice "voice/11-scene_11-159.ogg" #Leona (Dot)
    le "That was her! She said the radiation is subsiding!"

    #voice "voice/11-scene_11-160.ogg" #Raine (Nat)
    mc "Really? She must have tied herself into communications through the Ark..."

    #voice "voice/11-scene_11-161.ogg" #Leona (Dot)
    le "Who cares?! We're saved!"

    #voice "voice/11-scene_11-162.ogg" #Leona (Dot)
    le "Get up, we gotta go celebrate!"

    #voice "voice/11-scene_11-163.ogg" #Leona (Dot)
    ...
    #voice "voice/11-scene_11-164.ogg" #Leona (Dot)
    le "Juneau! We did it!"

    #voice "voice/11-scene_11-165.ogg" #Juneau (Lily)
    ju "Didn't I {b}just{/b} tell you that?"

    #voice "voice/11-scene_11-166.ogg" #Raine (Nat)
    mc "Give her a minute, she's a little high on life."

    #voice "voice/11-scene_11-167.ogg" #Leona (Dot)
    le "Hey, you should be just as happy!"

    #voice "voice/11-scene_11-168.ogg" #Leona (Dot)
    le "Afterall, we got big days ahead of us, don't we, Rainey?"

    #voice "voice/11-scene_11-169.ogg" #Raine (Nat)
    mc "Excuse me?"

    #voice "voice/11-scene_11-170.ogg" #Juneau (Lily)
    ju "Rainey?"

    #voice "voice/11-scene_11-171.ogg" #Juneau (Lily)
    ju "Girl, I don't know what you did, but keep it up."

    #voice "voice/11-scene_11-172.ogg" #Juneau (Lily)
    ju "You might not die alone at this rate."

    #voice "voice/11-scene_11-173.ogg" #Raine (Nat)
    mc "You, shut face!"

    #voice "voice/11-scene_11-174.ogg" #Leona (Dot)
    le "Tehehe, you're not embarrassed now, are you?"

    #voice "voice/11-scene_11-175.ogg" #Raine (Nat)
    mc "What? No. No!"

    #voice "voice/11-scene_11-176.ogg" #Leona (Dot)
    le "Oh ho? You should tell her then."

    #voice "voice/11-scene_11-177.ogg" #Raine (Nat)
    mc "Yeah, yeah."

    #voice "voice/11-scene_11-178.ogg" #Juneau (Lily)
    ju "This oughta be good."

    #voice "voice/11-scene_11-179.ogg" #Raine (Nat)
    mc "Well, for starters. We made up."

    #voice "voice/11-scene_11-180.ogg" #Leona (Dot)
    le "You mean 'out'."

    #voice "voice/11-scene_11-181.ogg" #Raine (Nat)
    mc "Shhh!"

    #voice "voice/11-scene_11-182.ogg" #Juneau (Lily)
    ju "Raine, you didn't actually {i}share{/i} your {i}feelings{/i} did you?!"

    #voice "voice/11-scene_11-183.ogg" #Raine (Nat)
    mc "I hate you. So much."

    #voice "voice/11-scene_11-184.ogg" #Juneau (Lily)
    ju "This {b}is{/b} cause to celebrate...!"

    #voice "voice/11-scene_11-185.ogg" #Leona (Dot)
