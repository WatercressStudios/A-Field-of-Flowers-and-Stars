label scene_8:
    ...
    #voice "voice/8-scene_8-1.ogg" #Leona (Dot)
    le "I am so-!"

    #voice "voice/8-scene_8-2.ogg" #Leona (Dot)
    le "STUPID!"
    ...
    #voice "voice/8-scene_8-3.ogg" #Leona (Dot)
    le "Stupid!"
    ...
    #voice "voice/8-scene_8-4.ogg" #Leona (Dot)
    ...
    #voice "voice/8-scene_8-5.ogg" #Leona (Dot)
    le "...I'm gonna lose my job, aren't I?"

    #voice "voice/8-scene_8-6.ogg" #Leona (Dot)
    le "...Idiot. That isn't important at all right now."

    na "Stop moping around!"

    #voice "voice/8-scene_8-7.ogg" #Leona (Dot)
    le "{b}Get.{/b}"

    #voice "voice/8-scene_8-8.ogg" #Leona (Dot)
    le "{b}Up!{/b}"
