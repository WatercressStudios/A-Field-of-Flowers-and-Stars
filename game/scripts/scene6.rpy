label scene6:
    ...
    le happy speaking a2 "Whatever that means. I think it's nice 'n' toasty."
    ...
    questioning2 "What?"
    le happy a2 with bounce "Rust! We're getting close to something." 
