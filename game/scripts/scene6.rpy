...
label scene_6:
    ...
    #voice "voice/6-scene_6-4.ogg" #Raine (Nat)
    ...
    #voice "voice/6-scene_6-6.ogg" #Leona (Dot)
    ...
    #voice "voice/6-scene_6-7.ogg" #Raine (Nat)
    ...
    show le explaining with dissolve:
        xalign 0.5
    #voice "voice/6-scene_6-10.ogg" #Leona (Dot)
    ...
    #voice "voice/6-scene_6-16.ogg" #Leona (Dot)
    ...
    #voice "voice/6-scene_6-24.ogg" #Leona (Dot)
    le questioning p2 "Yeah, what of it?"
    #voice "voice/6-scene_6-25.ogg" #Raine (Nat)
    ...
    #voice "voice/6-scene_6-27.ogg" #Leona (Dot)
    le concerned "...I don't follow."
    #voice "voice/6-scene_6-28.ogg" #Raine (Nat)
    mc questioning2 "Are there any rocks you can pick up around us?"
    #voice "voice/6-scene_6-29.ogg" #Leona (Dot)
    le "Plenty."
    #voice "voice/6-scene_6-30.ogg" #Raine (Nat)
    ...
    #voice "voice/6-scene_6-32.ogg" #Leona (Dot)
    ...
    le "Smell that?"
    #voice "voice/6-scene_6-34.ogg" #Raine (Nat)
    ...
    #voice "voice/6-scene_6-36.ogg" #Raine (Nat)
   ...
   # BG goes completely dark, just a black screen. Maybe a spooky cave sound effect?
    ...
    #voice "voice/6-scene_6-44.ogg" #Raine (Nat)
    ...
    #voice "voice/6-scene_6-47.ogg" #Raine (Nat)
    mc "I guess I'm just used to doing stuff on my own."
    #voice "voice/6-scene_6-48.ogg" #Leona (Dot)
    ...
    #voice "voice/6-scene_6-50.ogg" #Raine (Nat)
    ...
    #voice "voice/6-scene_6-51.ogg" #Leona (Dot)
    le relaxed "So, uh…"
    ...
    #voice "voice/6-scene_6-59.ogg" #Raine (Nat)
    ...
    #voice "voice/6-scene_6-61.ogg" #Raine (Nat)
    ...
    show le happy a2 with dissolve:
        align 0.5
        bounce
    #voice "voice/6-scene_6-63.ogg" #Leona (Dot)
    le "Books? Lemme see!"#vary it up a bit here
    #voice "voice/6-scene_6-64.ogg" #Raine (Nat)
    mc "Yeah, you have fun with that. I'll take a crack at this big ol' door I guess."
    ...
    mc "One thing's for sure, this control panel's as old as dirt. Wanna take a guess at how long it's been here?"
    #voice "voice/6-scene_6-66.ogg" #Leona (Dot)
    ...
    #voice "voice/6-scene_6-69.ogg" #Raine (Nat)
    ...
    #voice "voice/6-scene_6-91.ogg" #Leona (Dot)
    ...
    #voice "voice/6-scene_6-93.ogg" #Raine (Nat)
    mc questioning2 "I'd be surprised if I didn't. What the hell was that?"
    #voice "voice/6-scene_6-94.ogg" #Leona (Dot)
    ...
    #voice "voice/6-scene_6-96.ogg" #Raine (Nat)
    mc "Are you sure?"
    #voice "voice/6-scene_6-97.ogg" #Leona (Dot)
    ...
    #voice "voice/6-scene_6-99.ogg" #Raine (Nat)
    mc "Do you smell anything?"
    #voice "voice/6-scene_6-100.ogg" #Leona (Dot)
    le questioning a3 "What does that matter?"
    #voice "voice/6-scene_6-101.ogg" #Raine (Nat)
    mc "It matters. Is there more sulfur than before? Anything that might be a gas?"
    #voice "voice/6-scene_6-102.ogg" #Leona (Dot)
    ...
    #voice "voice/6-scene_6-104.ogg" #Raine (Nat)
    mc "Okay... But don't get too far away. Talk to me so I don't lose you again."
    #voice "voice/6-scene_6-105.ogg" #Leona (Dot)
    le "Good idea."
    ...
    #voice "voice/6-scene_6-106.ogg" #Raine (Nat)
    ...
    show le happy a2:
        xalign 0.5
        bounce
    #voice "voice/6-scene_6-108.ogg" #Leona (Dot)
    le "H-Hey, Raine! Can you stay there for a second?"
    #voice "voice/6-scene_6-109.ogg" #Raine (Nat)
    mc questioning "Everything alright up there?"
    #voice "voice/6-scene_6-110.ogg" #Leona (Dot)
    le happy speaking a3 "Yeah! Just need to check something out, won't take me long!"
    ...
    #voice "voice/6-scene_6-111.ogg" #Raine (Nat)
    ...
    #voice "voice/6-scene_6-122.ogg" #Leona (Dot)
    le "There was a pile of bones n stuff and I didn't want you to see it."
    #voice "voice/6-scene_6-123.ogg" #Raine (Nat)
    ...
    #voice "voice/6-scene_6-125.ogg" #Leona (Dot)
    ...
    #voice "voice/6-scene_6-128.ogg" #Raine (Nat)
    mc "At least we know what that noise was."
    #voice "voice/6-scene_6-129.ogg" #Leona (Dot)
