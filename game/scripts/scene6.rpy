label scene6:
   ...
   # BG goes completely dark, just a black screen. Maybe a spooky cave sound effect?
    ...
    le crying "It's okay, it's okay. I'm just happy you're okay. You're with me now, right?"
    mc sighing "R-right."
    ...
    le suspicious "I think it was back the way we came?"
    mc "Are you sure?"
   ...
   # ART - Cave1BG
    ...
    le happy a2 "H-Hey, Raine! Can you stay there for a second?"
    ...
    le le speakingsurprised a1 "...Oops. That was louder than I thought."
    ...
    le relaxed "I'm fine, I'm fine! I just had to close a door."
    ...
    le suspicious "I don't think we should open that door again. Ever."
