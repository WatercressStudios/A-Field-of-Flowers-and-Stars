label scene_6:
    ...
    #voice "voice/6-scene_6-35.ogg" #Leona (Dot)
   ...
   # BG goes completely dark, just a black screen. Maybe a spooky cave sound effect?
    ...
    #voice "voice/6-scene_6-45.ogg" #Raine (Nat)
    ...
    #voice "voice/6-scene_6-46.ogg" #Leona (Dot)
    ...
    #voice "voice/6-scene_6-49.ogg" #Leona (Dot)
    ...
    #voice "voice/6-scene_6-52.ogg" #Leona (Dot)
    le relaxed "So, uh…"
    #voice "voice/6-scene_6-53.ogg" #Raine (Nat)
    mc questioning2"Yeah?"
    #voice "voice/6-scene_6-54.ogg" #Leona (Dot)
    ...
    #voice "voice/6-scene_6-107.ogg" #Raine (Nat)
    ...
    #voice "voice/6-scene_6-112.ogg" #Raine (Nat)
    ...
    na "..."
    #voice "voice/6-scene_6-121.ogg" #Raine (Nat)
    mc "...Leona?"
    ...
    #voice "voice/6-scene_6-124.ogg" #Raine (Nat)
    ...
    #voice "voice/6-scene_6-126.ogg" #Leona (Dot)
    ...
    #voice "voice/6-scene_6-130.ogg" #Leona (Dot)
