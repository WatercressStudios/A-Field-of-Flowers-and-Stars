label scene6:
    ...
    show mc unimpressed
    mc "I think I'd rather be out there in the direct sunlight, thanks."
    mc "Besides, if you think it's freezing outside, you'd hate Lumin."
    show le questioning p2
    le "The sun and exercise is good for you! You're so pale... and thin? What's a good word for it...?"
    na "Leona pokes at my arms through the shroud of darkness."
    show mc shocked armraised
    mc "NYuUugH, no touchy. I can already feel my skin crawling, it's so humid in here."
    show mc blech
    mc "Please, PLEASE tell me there’s no blood-sucking bugs in here, eyuckh..."
    na "Leona and I make our way through the deep, deep cave."
    play sfx "SFX/footsteps 1.ogg"
    ...
    show mc questiong2
    mc "How does a species from a bright desert planet even get off having such good night vision anyway?"
    show le speaking a2
    le "I dunno. I've always liked small, dark corners, but so does everyone else I know."
    le "Mom always said Dad loved these sorts of places when the colony arrived."
    mc "I'll take your word for it..."
    na "I give a small sigh as we move deeper in."
    le "Are you sure you don't want to use the flashlight?"
    mc "It's fine, I can't tell how much charge the battery has in it anyway. Better to save it for an emergency."
    ...
    le "Hmm... Oh!"
    le "I found the word I was looking for. You’re scrawny!"
    mc "I'll show you scrawny, ya dingbat."
    le "Oho? And how will you do that?"
    na "A playful smirk comes across my face."
    mc "Let's just say I have a little secret."
    le "I like secrets. Tell me."
    mc "Do you remember when you cut me down out of that tree?"
    mc "Specifically the part when you jumped to catch me?"
    le "Yeah, what of it?"
    mc "Well, something about that seemed off."
    mc "I thought it was just the adrenaline at the time, but it didn't seem like we fell very hard."
    le "...I don't follow."
    mc "Are there any rocks you can pick up around us?"
    le "Plenty."
    mc "Grab two that are roughly the same size and weight and hold onto them for me."
   ...
   # BG goes completely dark, just a black screen. Maybe a spooky cave sound effect?
    ...
    mc "Thank you, Leona. If it weren't for you, I'd be a goner."
    ...
    le "Maybe they needed to hide something in it? It's weird that they'd leave this crate outside though."
    ...
    mc "Nope, I don't think that's it."
    ...
    mc "Spitballing it, a couple hundred years or so?"
    ...
    mc "There's definitely something like a generator behind this, but…"
    ...
    mc "Leona, do you have any sort of lubricant I can use here?"
    le "Lube? How much do you need? I have a little bit of moisturizer that might work. "
    ...
    le "There ya go. What are you gonna do with it if it comes out?"
    ...
    le "I think it was back the way we came?"
    mc "Are you sure?"
   ...
   # ART - Cave1BG
    ...
    mc "Everything alright up there?"
    le "Yeah! Just need to check something out, won't take me long!"
    ...
    mc "You'll be alright, right!?"
    le "I'll be fine! Just stay there!"

    ###
    #SFX - GLASS SHATTERING SOUND
    ###

    na "A sudden loud, mechanical grinding forces an audible wince out of me."
    na "About as bad as nails on a chalkboard."
    le "...Oops. That was louder than I thought."
    mc "Everything alright? I think my ears are ringing."
    le "Y-Yeah. God, that hurt."
    mc "Are you alright?! What the hell was that!?"
    le "I'm fine, I'm fine! I just had to close a door."
    mc "You found a door? Why didn't you just say so?"
    le "Because... well..."
    na "..."
    mc "...Leona?"
    le "Bodies. We must have done something back in the alcove that opened a door over here."
    le "There was a pile of bones n stuff and I didn't want you to see it."
    mc "Bodies? You mean, like {i}people{/i} bodies?"
    le "I couldn't tell. The room was full of them. Not a pretty sight."
    le "I don't think we should open that door again. Ever."
    mc "If you say so..."
    mc "But now I'm really curious about whoever was here before us."
    mc "At least we know what that noise was."
    le "Can we please move on now? Just knowing what's on the other side of this door is giving me the shivers."
    mc "Yeah, let's go back home. I don't want to hang around any longer either."
    ...
    mc "Detour? To where?"
    le "There's something I want to check out. These books gave me an idea."
    na "I quickly catch up to Leona, my nerves calming down now that she's beside me once again."
    mc "Well, alright. We have daylight to burn anyway. Besides, I have a little present I've been meaning to give you."
    le "Oooh, I never get presents!"
    mc "Then I'm sure you'll love it."
    mc "Now, what were we talking about before? Architecture?"
    le "Right, as I was saying, the family and the home are equally important-"
