label scene_6:
    ...
    voice "voice/6-scene_6-1.ogg" #Leona (VA Name)
    le "So!"

    voice "voice/6-scene_6-2.ogg" #Raine (VA Name)
    mc "So?"

    voice "voice/6-scene_6-3.ogg" #Leona (VA Name)
    ...
    voice "voice/6-scene_6-4.ogg" #Raine (VA Name)
    mc "What, coffee?"

    voice "voice/6-scene_6-5.ogg" #Leona (VA Name)
    le "What? Coffee?"

    voice "voice/6-scene_6-6.ogg" #Leona (VA Name)
    ...
    voice "voice/6-scene_6-7.ogg" #Leona (VA Name)
    le "It tastes a bit bitter if you drink it alone, but with the right cream, it's wonderful!"

    voice "voice/6-scene_6-8.ogg" #Raine (VA Name)
    mc "You... you want to go to a cafe."

    voice "voice/6-scene_6-9.ogg" #Leona (VA Name)
    ...
    voice "voice/6-scene_6-10.ogg" #Raine (VA Name)
    mc "Alright. I'm down."

    na "Leona's face lights up like the sun."

    voice "voice/6-scene_6-11.ogg" #Leona (VA Name)
    le "Yes! It's a date! Let's go right now!"

    voice "voice/6-scene_6-12.ogg" #Raine (VA Name)
    mc "Right now?"

    voice "voice/6-scene_6-13.ogg" #Leona (VA Name)
    le "Yesyesyes!"

    voice "voice/6-scene_6-14.ogg" #Raine (VA Name)
    ...
    voice "voice/6-scene_6-16.ogg" #Leona (VA Name)
    le "Raaaaaine? Raaaaaaaaaaaine? RAINE!"

    voice "voice/6-scene_6-17.ogg" #Raine (VA Name)
    mc "I-uh, what? Hmm?"

    voice "voice/6-scene_6-18.ogg" #Leona (VA Name)
    ...
    voice "voice/6-scene_6-19.ogg" #Raine (VA Name)
    mc "Right. Sorry."

    voice "voice/6-scene_6-20.ogg" #Leona (VA Name)
    le "It's okay! Everyone {i}spaces{/i} out from time to time."

    na "Please, god no."

    voice "voice/6-scene_6-21.ogg" #Leona (VA Name)
    le "Spacing out? Get it? Cause you're from space?"

    voice "voice/6-scene_6-22.ogg" #Raine (VA Name)
    mc "I'll take the darkest shit you have."

    voice "voice/6-scene_6-23.ogg" #Leona (VA Name)
    le "Awww, don't be like that."

    voice "voice/6-scene_6-24.ogg" #Raine (VA Name)
    mc "Hey, I like it bitter."

    voice "voice/6-scene_6-25.ogg" #Leona (VA Name)
    le "Bitter? Oh, you don't want dark, then."

    voice "voice/6-scene_6-26.ogg" #Raine (VA Name)
    mc "I-Oh, right. This isn't really coffee, not like I'm used to. Just get me whatever's bitter, please."

    voice "voice/6-scene_6-27.ogg" #Leona (VA Name)
    le "And I'll take my usual! Thank you thank you!"

    voice "voice/6-scene_6-28.ogg" #Raine (VA Name)
    mc "So, what bean is this stuff made from again?"

    voice "voice/6-scene_6-29.ogg" #Leona (VA Name)
    le "No beans! It's made from the best fung-"

    voice "voice/6-scene_6-30.ogg" #Raine (VA Name)
    mc "{b}Nevermind{/b}, nevermind. I didn't hear a thing, I don't want to hear a thing, I'm good."

    voice "voice/6-scene_6-31.ogg" #Leona (VA Name)
    le "But it's-"

    voice "voice/6-scene_6-32.ogg" #Raine (VA Name)
    mc "Noooope. Nope."

    voice "voice/6-scene_6-33.ogg" #Leona (VA Name)
    le "No fun..."
    ...
    voice "voice/6-scene_6-34.ogg" #Leona (VA Name)
    ...
    voice "voice/6-scene_6-35.ogg" #Raine (VA Name)
    mc "It's a bit arid, though. A little too hot for me."

    voice "voice/6-scene_6-36.ogg" #Leona (VA Name)
    le "Says you, voidborn! It's perfect here for us."

    voice "voice/6-scene_6-37.ogg" #Raine (VA Name)
    ...
    voice "voice/6-scene_6-38.ogg" #Leona (VA Name)
    ...
    voice "voice/6-scene_6-39.ogg" #Raine (VA Name)
    mc "Doesn't that get a bit boring to you, though?"

    voice "voice/6-scene_6-40.ogg" #Leona (VA Name)
    le "How could it?"

    voice "voice/6-scene_6-41.ogg" #Leona (VA Name)
    ...
    voice "voice/6-scene_6-42.ogg" #Raine (VA Name)
    ...
    voice "voice/6-scene_6-43.ogg" #Leona (VA Name)
    le "Another space to explore."

    voice "voice/6-scene_6-44.ogg" #Raine (VA Name)
    ...
    voice "voice/6-scene_6-45.ogg" #Leona (VA Name)
    le "That's a little cynical. I hope we'll never be like that."

    voice "voice/6-scene_6-46.ogg" #Leona (VA Name)
    ...
    voice "voice/6-scene_6-47.ogg" #Leona (VA Name)
    le "If I could fly, I'd never take it for granted. Never, ever ever."

    voice "voice/6-scene_6-48.ogg" #Raine (VA Name)
    mc "You know, I can see that. You don't seem the cynical type."

    voice "voice/6-scene_6-49.ogg" #Leona (VA Name)
    le "You bet!"

    voice "voice/6-scene_6-50.ogg" #Raine (VA Name)
    mc "I hope one day you'll get to experience the stars. I think you'd get a lot out of it."

    voice "voice/6-scene_6-51.ogg" #Leona (VA Name)
    ...
    voice "voice/6-scene_6-52.ogg" #Leona (VA Name)
    le "Oh! You've finished your drink. Want a refill? Did you like it? I hope you liked it!"

    voice "voice/6-scene_6-53.ogg" #Raine (VA Name)
    ...
    voice "voice/6-scene_6-54.ogg" #Raine (VA Name)
    mc "I'm good for now, though. Maybe we can grab another drink before I leave."

    voice "voice/6-scene_6-55.ogg" #Leona (VA Name)
    le "Maybe."

    voice "voice/6-scene_6-56.ogg" #Leona (VA Name)
    le "So! Let's head back to the house. I have something I want to show you!"

    voice "voice/6-scene_6-57.ogg" #Raine (VA Name)
    mc "Oh?"

    voice "voice/6-scene_6-58.ogg" #Leona (VA Name)
    le "Yep! I think you could use a little reminder, so to speak. Just you wait!"

    voice "voice/6-scene_6-59.ogg" #Raine (VA Name)
    mc "Alright, let's go."

    voice "voice/6-scene_6-60.ogg" #Raine (VA Name)
